...
La masse $b$ de bicodon, relativement à l'électron, donnée par l'Eq. (12), présente un écart $ 5 \times 10^{-4}$, qui est \textit{l'incertitude actuelle de la masses effective, tenant compte de la distribution des isotopes, mal connue à cause de variations locales} \cite{Wichers}. Plus précisément, à 10 ppm près:

\begin{equation}
 \sqrt b \approx (pn)^2/H^3
 \end{equation}

...
Toutes ces dimensions sont considérées dans la théorie des supercordes, sauf la dimension 12. Mais la racine carrée du rapport de masse boson scalaire/électron, le nombre 495, central dans le présent article, est $C_12^4$, voir ci-dessous.

...
Les théories actuelles (théorie des cordes, modèle des boucles, ...) débouchent sur la question de la structure de l'espace-temps.
...
des équations gravito-quantiques, qui symétrisent $G$ et $\hbar$, constantes associées à des masses $m_G$ et $m_{\hbar}$:

...
\label{tab:2:table2}
  \hskip-2.0cm\begin{tabular}{llll}
    ...
    Wien factor $ wi = 5(1-e^{-wi})$ &  w_i  & 4.96514245  & "exact" \\
...
La Table \ref{tab:6:table6} présente 14 formules pour ce rayon de Hubble. 
...
Le fait que le soi-disant "age de l'univers" soit très voisin de $R/c$ montre que les équations de la cosmologie standard renferment une part de vérité, mais sont mal interprétées.  

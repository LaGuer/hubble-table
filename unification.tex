...
\node [anchor = east,color=black] at (12.25,12.250){$SCALAR BOSON$};
...
\node [anchor = east,color=green!85!black] at (15.25,15.250){$PHOTON$};
\node [anchor = west,color=red] at (15.25,15.250){KOTOV length $*2\pia$};
\node [anchor = west,color=red] at (17.25,17.250){$Galaxy group$};
\node [anchor = east,color=green!85!black] at (19.25,19.250){$GRAVITON$};

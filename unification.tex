...
\begin{table}
\caption[Table \ref{CosmosTable}: 26 Cosmos radius formula]{26 formula for $R_C$}
\label{CosmosTable}
  \hskip-2.0cm\begin{tabular}{lll}
    \toprule
   % \multicolumn{3}{c}{}                   \\
...
2^{1/12} \approx (1+\mu+\tau)/\tau
 ...
 Cette corrélation répertoriée \cite{Sternheimer} explique la conjonction ci-dessus les deux cercles Weinberg-Koide. 

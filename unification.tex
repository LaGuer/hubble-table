...
The Weigel team\cite{Weigel} (table 6.7) extended this calculation for higher dimensions, up to $d=70$, concentrating on the \textit{the positive symmetry number}, noted $K_{d}$, which defines $N_d$ via: 

...
Les masses équivalentes des quarks apparaissent dans la double connexion avec le boson scalaire $H^0$ et le Nombre Holique $210^{210}$:

\begin{equation}
p_G /a^{3/2}  \approx (p_G -\tau/H)^{u^2d-1/2} \approx (H^0)^{(ud^2+1)/2}
\end{equation}

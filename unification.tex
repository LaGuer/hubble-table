...
%Ecken
\node[left= 1pt of A]{$Newtonian Mechanics$};
\node[right= 1pt of B]{$RR$};
\node[right= 1pt of C]{$Quantum Mechanics$};
\node[left= 1pt of D]{$Newtonian Gravitation$};
\node[left= 1pt of E]{$QFT$};
\node[right= 1pt of F]{$GR$};
\node[right= 1pt of G]{$QG$};
\node[left= 1pt of H]{$GUT$};

%Kanten
\draw[] (A) 
-- (B)  node[midway, below]{\tiny$\a$c}
-- (C)      node[midway, right]{\tiny$\a$G}
-- (D)  node[midway, above]{\tiny$\a$h}

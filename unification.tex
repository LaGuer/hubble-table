...
\begin{equation}
 \left\{
    \begin{array}{ll}
         Cytosine : ~ ~~C_{9}^{(0)}~H_{12}^{(0)}~N_3^{(0)}~O_6^{(0)}~P^{(0)} (150 p + 139 n_t) : ~ C_y^{(0)} \approx 286.8021362 \approx 495 (a^3/n_t^2)^2 \approx WH/4an_t\\
        \\
         Thymine : ~~~ C_{10}^{(0)}~H_{13}^{(0)}~N_2^{(0)}~O_7^{(0)}~P^{(0)} :  T_h^{(0)} \approx301.68553403 \approx \sqrt a_w (\pi n_t/aH)^2 \\ 
         
         \\
             
         Adenine : ~~~ C_{10}^{(0)}~H_{12}^{(0)}~N_5^{(0)}~O_5^{(0)}~P^{(0)}:~  A_d^{(0)} \approx310.6269397 \approx \sqrt a_w /(1.6)^{16}\\
         
         \\
        
         Guanine : ~~~~ C_{10}^{(0)}~H_{12}^{(0)}~N_5^{(0)}~O_6^{(0)}~P^{(0)}(170 p + 159 n_t) :   G_u^{(0)} \approx326.4976654 \approx 495 \sqrt{137a/\beta}/\mu d_e^4 \approx Z/2\Pi_+\\

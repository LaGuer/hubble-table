...
R_N = 2r_e^3/l_P^2 = 2 \hbar^2/Gm_N^3 ~~~~~~~~~~~~ M_N = m_P^4/m_N^3
 ...
 Ce rayon $R_N$ est légèrement supérieur (30\%) à l'horizon $R$ de l'Univers, et est considéré comme le "rayon holographique réduit" du Cosmos de rayon $R_C$, défini par la conservation holographique $2\piR_C/l_P = \pi (R_N/l_P)^2$, soit:

...
\begin{equation}
 \left\{
    \begin{array}{ll}
         Cytosine : ~ ~~C_{9}^{(0)}~H_{12}^{(0)}~N_3^{(0)}~O_6^{(0)}~P^{(0)} ~(150 pr. + 139 nt. \rightarrow 439 part.) : ~ C_y^{(0)} \approx 286.8021362 \approx 495 (a^3/n_t^2)^2 \approx WH/4an_t\\
        
         Thymine : ~~~ C_{10}^{(0)}~H_{13}^{(0)}~N_2^{(0)}~O_7^{(0)}~P^{(0)} ~(158 pr. + 146 nt. \rightarrow 450 part.) :  T_h^{(0)} \approx301.68553403 \approx  \sqrt {a_w}~\Pi_0/H\Pi_+ \\ 
         
         \\
             
         Adenine : ~~~ C_{10}^{(0)}~H_{12}^{(0)}~N_5^{(0)}~O_5^{(0)}~P^{(0)}:~(162 pr. + 151 nt. \rightarrow 475 part.):  A_d^{(0)} \approx310.6269397 \approx \sqrt {a_w} /pd_e^{4}\\
         
         \\
        
         Guanine : ~~~~ C_{10}^{(0)}~H_{12}^{(0)}~N_5^{(0)}~O_6^{(0)}~P^{(0}~(170 p + 159 n_t \rightarrow 499 part.) :   G_u^{(0)} \approx326.4976654 \approx 495 (137a/\beta)^ {1/2}/\mu d_e^{4}\approx Zp/2H\Pi_+\\

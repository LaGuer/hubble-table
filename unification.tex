...
\textit{The Riemann conjecture would imply that $s_0$ is really the maximal suitable number, and that only one more can exist, very larger than $s_0$. So the proton-electron ratio is at the heart of Number Theory.}

...
\label{tab:2:table2}
  ...
  %This work "weak-mixing angle" & $(\sin \theta)^2(m_Z)$    & 0.231475 &  \\
   ...
   Optimized "Squared Weak-mixing angle" $qR/R_N$  & $(\sin \theta)^2$    & 0.2311293 & this work \\
   
  Effective "Squared Weak-mixing angle"  & $(\sin \theta_{effZ})^2$    & 0.23148(4) & $1.7 \times 10^7$ \\
  
   Optimized Eff. "Squared Weak-mixing angle" $(ln\Phi)^2$  & $(\sin \theta_{effZ})^2$    & 0.23156482 & this work \\

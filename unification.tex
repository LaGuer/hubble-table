...
Le concept d'Univers en expansion étant éliminé, seule reste celui d'"équilibre dynamique". La courbure de l'espace-temps n'est alors qu'une propriété locale, tandis que l'Univers dans son ensemble présente une géomérie dite "plate", c'est-à-dire euclidienne. Bondi \cite{Bondi} : \textit{It was only in 1934 that Milne and McCrea reverted to the Newtonian problem and showed that, with a suitable interpretation of the Newtonian terms, Newtonian cosmology was in many respets completely equivalent to relativistic cosmology.}. En particuler, la condition critique est identification à $c$ de la vitesse de libération à la surface d'une sphère de rayon $R$ et de masse $M$:

...
\label{tab:6:table6}
 ...
 $ (\lambdabar_{p} \lambdabar_{H})^{1/2} a_w^(7/2) a/2\sqrt 5 $  & 13.81197801 & D'après la relation $(WZ)^8 \approx a^2a_w^7/20$\\
...
\subsction{L'inexplicable périodicité des décalages Doppler cosmiques}
...
L'analyse montre qu'une approximation du nombre d'or $\Phi$ apparaît dans:

...
Par contre, dans la Cosmologie Permanente
%\cite{Sanchez2},
où l'horizon $R$ est invariant,
on peut lier cette distance avec le rayon classique de l'életron $r_e$.
On définit ainsi le "rayon de Nambu" $R_N$,
lié à la masse de Nambu $m_N = am_e$
(le facteur 2 venant de la relation de Shwarszchild $R_N  = 2GM_N /c^2$): 

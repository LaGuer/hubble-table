...
Rappelons que celle-ci est avantageusement remplacée par une force répulsive entre galaxies, proportionnelle à la distance, correspondant à la constante cosmologique que Hilbert avait suggéré à Einstein pour compléter ses équations. En effet, la récession galactique est donc accélérée, ce qui a été une totale surprise pour les cosmologues standards. La raison d'être de cette force est qu'elle autorise un renouvelement par des bébé-galaxies, effectivement observées par Halton Arp \cite{Arp}, empéchant ainsi l'Univers de finir dans un 'Big Child', comme c'est le cas dans la cosmologie standard actuelle.

Cette récession galactique n'est pas le seul phénomène à permettre un renouvelement de la matière, rendu nécessaire par le fait que les étoiles sont mortelles. Ce serait aussi le rôle des trous noirs géants d'éliminer les vieilles galaxies au profit de nouvelles. Les trous noirs agissent à l'intérieur d'un amas de galaxie, tandis que la répusion est effecrive à des distances supéreures au milion d'années-lumière.

\textit{Ainsi le second pricipe de la thermodynamique, qui prédit un sort fatal à tout systême isolé est contourné par ces deux phénomènes: la répulsion galactique entre amas et les trous noirs géants à l'intéroeur des amas}.
...
q = {q'} \sin\theta = {q''} \cos\theta 
 ...
 Le triangle de Weinberg (Fig.) illustre ces relations. Le cercle circonscrit fait apparaître le nombre musical $2^{1/12}$, qui est voisin de 

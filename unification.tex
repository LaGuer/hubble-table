...
\begin{table}
\caption[Table \ref{CosmosTable}: 12 Cosmos radius formula]{12 formula for $R_C$}
\label{CosmosTable}
  \hskip-2.0cm\begin{tabular}{lll}
    \toprule
    \multicolumn{3}{c}{}                   \\
 ...
 $ 2r_H 3^{210}/p_0$& 9.075770 & Holique base 3, avec $p_0 = 1830 = 60\times 61)/2$   \\
  ...
  $ \lambdabar_e (Z/W)^{aw^2_sin\theta(Z)^2} $ & 9.0754 & base $Z/W = 1/cos\theta$ \\
 ...
 $ \lambdabar_e (H/p)^2 g(7) P/6 $ & 9.0763 & Pertinence de la fonction topologique $g(7) = f(30)/7$ \cite{Sanchez2}  \\
 ...
 $ \sqrt (Rl_{nl}^{3/2}/r_e^2 $ & 9.2 & Provient de l'holographie non-locale \cite{Sanchez2}  \\

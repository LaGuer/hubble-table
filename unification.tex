...
\draw[color=blue] (A) -- (Y);
\node [anchor = east,text=blue] at (0.,33.75) {\Large{TOPOLOGICAL AXIS}};
\node [anchor = east,text=blue] at (0.,31.75) {Caracteristics length follow the law $exp(2^{d/4})$, unit length: electron Compton reduced wavelength: $\hbar m_ec=\lambdabar_e$}};
\node [anchor = east,text=blue] at (0.,31.75) {\textbf{Super Period} unit: $\lambdabar_e/c$. \textbf{Photonde} and \textbf{Gravitonde} masses unit: $2\pi m_N$}};

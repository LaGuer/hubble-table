...
L'importance arithmétique du nombre 495 sera détaillée dans le chapitre suivant. En identifiant $H^0 = 495^2$, cela définit la charge de jauge $q' = q/sin\theta$, qui est donc en relation approchée simple avec $S^{(26)}$:

...
Ces masses sont voisines de la masse de Fermi $m_F/m_H \approx 311.8997032 $. Avec $o_1$ et $o_2$ les masses brutes des couples AT et GC, la masse brute moyenne est $ (o_1 + o_2)/4 \approx 306.4032199$, voisin de $\pi^5 \approx 306.019684$. 


La masse moyenne du bi-codon, composé de six nucléotides $m_{bc}/m_H = (6/4)(o_1 + o_2) \approx 1838.418122$  est donc voisine de $p_W = 6 \pi^5$, la masse de Lenz-Wyler. Plus précisément, à 0.1 ppm près:
...
La masse $b$ de bicodon, relativement à l'élecron, donnée par l'Eq. (12) présente un écart $ \approx 4.74941 \times 10^{-4}$, qui est \textit{l'incertitude actuelle des masses isotopiques effectives}. Elle vérifie, au ppb près:

\begin{equation}
 b \approx (p_K/\sqrt{pH})(p_W d_e ()o_1/(o_1+1))^2
 \end{equation}

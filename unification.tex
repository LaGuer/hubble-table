...
The Diophantine Kepler's law symmetries gravitation and quantum, connecting the Bohr’s orbits, the quasar non-local period, the Hubble radius, the Cosmos radius and the CMB temperature of the Permanent Holographic Oscillatory Bang model. The mean DNA bi-codon mass is central and connects to 0.1 ppm with the Topological Axis. The geometric extension of the Weinberg triangle induces a scalar boson mass, which is connected to the 9D string dimension reduction by crystallographic symmetry. The running number of the string dimension series is identified with the orbital quantum number, associating the spin 1/2 and the string dimension 2. This confirms Eddington, Atiyah and the Combinatorial Hierarchy, leading to the gauge partition. This excludes the concepts of Multiverse, Continuum, Infinity, Locality and Zero mass Particle, leading to stringent predictions.  


\end{abstract}

\keywords{Computation Principle \and Holographic principle \and Holic Principle  \and Cosmology \and Number theory  \and String theory \and DNA nucleotides \and Crystallographic Symmetry \and Periodic Table \and Sporadic Groups.}

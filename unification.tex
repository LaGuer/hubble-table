...
Ce rayon $R_N$ est légèrement supérieur (environ 30\%) à l'horizon $R$ de l'Univers, et est considéré comme le "rayon holographique réduit" du Cosmos de rayon $R_C$, défini par la conservation holographique impliquant l'entropie de Bekenstein-Hawking de la sphère de rayon $RN$ : $\pi (R_N/l_P)^2 = 2\pi R_C/l_P$, soit:
...
Comme $o_1 + 1 \approx o_2$, la masse du bicodon ne varie au plus que de 3 masses hydrogène: \textit {l'ADN semble un calculateur à base 3, comme le Cosmos}. Noter que la base 3 est reconnue comme la base entière la plus efficace. Ce n'est que pour des raisons techniques que l'informatique actuelle n'utilise que la base 2.

...
Cette formule, précise à 5 ppb, est caractéristique de l'algèbre des octonions. \textit{Sir Atiyah avait effectivement prédit que la gravitation devait être liée à cet algèbre}\cite {Atiyah}:

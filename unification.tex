...
Dans le cadre de la Cosmologie de précision, le réexamen des corrélations entre grands nombres \cite{Sanchez2} conduit à l'Axe Topologique (Table \ref{tab:1:table1}), qui montre que le rayon de Hubble est invariant et confirme la théorie bosonique des cordes. 
...
\begin{equation}
R =  2 \hbar^2/Gm_e m_p m_H \approx 13.811977 \times 10^9 années-lumière
 \end{equation}
...
\begin{equation}
R \approx \lambdabar_e g(6) = 13.82 \times 10^9 années-lumière
 \end{equation}

...
\label{tab:6:table6}
 ...
 $ (l_P/2)(\lambdabar_{CMB}^2\lambdabar_p/lambdabar_{CNB}r_e^2)^6$  & 13.7    & Complémentarité des fonds microondes-neutrinos \\
  ...
  $ \lambdabar_{CNB}^2 lambdabar_{CMB}^4 (ln\Phi)^8/l_P^4 R_C H_0 $  & 13.812   & Role de $ln\Phi \approx (\sin \theta_{eff})(m_Z) $ \\
 
 
 
 
 
  $ (r_e^2R_C)^{2/3}/l_{nl}$  & 13.75    & Confirme le non-localité du Cosmos de rayon $R_C$ \\

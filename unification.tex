...
\begin{table}
\caption[Table \ref{CosmosTable}: 24 Cosmos radius formula]{24 formula for the Cosmos radius $R_C$}
\label{CosmosTable}
  \hskip-2.0cm\begin{tabular}{lll}
    \toprule
   % \multicolumn{3}{c}{}                   \\
 ...
 $e^{210}l_{Wien}\beta (\sin \theta_{effZ})^4$ & 9.07577 & confirms the Holic Principle and the CMB temperature   \\
 ...
 $ e^{\mu} \lambdabar_{CMB} (R_e/R)^2 (p_t/p_{t0})^4$ & 9.07584 & confirms the CMB temperatur invariance, with $p_{t0}$ = 1936 \\

...
\begin{table}
%\label{tab:6:table6}
\caption[Table \ref{tab:6:table6}: 22 Hubble radius formulas]{22 formula for $R$}
\label{tab:6:table6}
  \hskip-2.0cm\begin{tabular}{llll}
    \toprule
    \multicolumn{3}{c}{}                   \\
...
\label{tab:20:table20}
 ...
 $ l_P(p/H) (RPi_{26}/R_N)^{1/3} $ & 9.07579 & Pertinence du produit des 26 groupes sporadiques \cite{Sanchez2}  \\

...
\label{CosmosTable}
 ...
 $ Rl_{nl}^2c^2a_w/R_NGm_{bc} $ & 9.07375 & Principe Holique, avec $m_{ph} = \hbar /cl_{nl}$, $m_{gr} = m_{ph}/a_w$, avec  $m_{bc} \approx 1838.419
 ~m_H$ \cite{Sanchez3}   \\
 

 $ Ra_w l{nl}^2c^2/Gm_eH^2d_e$& 9.07581 & En approximant la masse du bicodon moyen par $H^2 d_e $   \\
...
\begin{equation}
 \left\{
    \begin{array}{ll}
        Cytosine~~_{4}C_{9}H_{12}N_3O_6P : ~ C_y \approx 286.802335\\
        Thymine~~ C_{10}H_{13}N_2O_7P :  T_h \approx301.68554\\
        Adenine~~ C_{10}H_{12}N_5O_5P :~  A_d \approx310.62714\\
        Guanine~~ C_{10}H_{12}N_5O_6P :   G_u \approx326.497864 
    \end{array}
\right.
\end{equation}

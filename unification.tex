...
La variation d'une unité de k conduit à 
...
\textit{Comme le groupe SU(2) ne concerne que les rotations dans un plan, il est naturel de compléter le triangle de Weinberg par un troisième axe portant l'unité.} (figure 6: Weinberg-Sanchez cuboid). On obtient un vecteur de module directement lié à la "clef holique" ci-dessus $2a^3/pH $, où $H$ est remplacé par la masse lucasienne du proton ci-dessus $p_G$. L'hypothèse que cette relation est exacte unifie la théorie életrofaible avec la gravitation:

...
\label{tab:6:table6}
 ...
 $ 2\hbar^2/Gm_em_pm_H $ & 13.81197676 & Rayon de la Molecule gravitationnelle d'Hydrogene \cite{Sanchez2}   \\
  ...
  $ R_N (sin\theta_Z)^2/ q$  & 13.81197676    & Identification, à partir de $(sin\theta_Z)^2$ et de la charge $q$  \\
  
  
  $(\lambdabar_{e} 2^{128}/d_e^2(m_H/m_p)^6$  & 13.811977    & Empirique, à partir du grand nombre de Lucas \\

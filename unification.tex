...
\begin{equation}
 ...
 où $w = \sqrt a_w/W$ est un paramètre central dans la théories électrofaible rappelée ci-dessous, associé au paramètre $z = \sqrt a_w/Z$. On en déduit les relations ($7 \times 10^{-5}$ et $2 \times 10^{-3}$):
...
où $W_+ =  W_-$ et $Z$ sont les masses des trois bosons de jauge électrofaibles, ce qui confirme la température cosmique dans le domaine du ppb. A moins d'admettre que nous vivons un siècle très particulier, force est d'admettre l'invariance de la température cosmique. Ceci est contraire aux data officiels, mais seules les observations conformes au paradigme cosmologique dominant sont publiées. 

...
\subsection{L'énegie cinétique des galaxies}
Dans la cinématique de de Sitter où la récession exponentielle, interprétée en cosmologie newtonienne, la loi de Hubble est rigoureusemen $v = cr/R$. Le ca lcul de l'énergie cinétique des galaxies est l'intégrale de $dm v^2/2$, avec $dm$ l'élémant de masse d'une coquille sprérique de rayon $r$ et d'épaisseur $dr$: $dm = d(Mc^2)(r/R)^3$. On en déduit $E_{cin} = (3/10)Mc^2$, l'opposé de l'énergie potentielle gravitationnelle critique, donc:
...
\bibitem{Riess} Nature Reviews Physics, year in review, 2019, published 18 dec 2019.
The Expansion of the Universe is Faster than Expected, https://arxiv.org/ftp/arxiv/papers/2001/2001.03624.pdf

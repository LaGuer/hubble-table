...
Les masses des bosons W et Z sont reliées à la masse du boson scalaire massif (Brout-englert_Higgs), voir le triangle de Weinberg (Fig). En le complétant par un troisième axe portant l'unité, on obtient un vecteur de module directement lié àla constante holique ci-dessus, où H est remplacé par la masse gravitationnele du proton gravitationnelle $p_G$ ci-dessus:

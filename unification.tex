...
\begin{equation}
\pi_e = ({q'} \sin\theta)^{2} a/4 = 4/\sqrt{\Phi_e}   \approx   3 + 2 \pi^{2a}^{\frac{3}{(137a_0)}^{2}}   
\end{equation}
...
\begin{equation}
(W^{2a}^{5137}^{\frac{3}{a_w}})^{7} \approx (Z^{6} \sqrt{a_w})^{3} \approx (1837p/16){3 \times 7} \approx (4 \sqrt{a_s})^{3 \times 5 \times 7} 
\end{equation}
...
\begin{equation}
Phi{_WZ} = (WZ)^{1/50} \approx (w+z)^{1/4}
\end{equation}


où $w = \sqrt a_w/W$ et $z = \sqrt a_w/Z$, avec $wz = \sqrt a_0$. Ainsi qu’il avait été prédit, le nombre d’or joue une place centrale dans la future théorie ultime. L’exposant 50 doit être lié à l’espace 5D, voir ci-dessous. L’ordinateur indique la corrélation avec le rapport de masse des leptons tau et mu, à 0.2 ppm :
...
On observe la corrélation à 23 ppm près :

\begin{equation}
{a''}/{a'} = cotg\theta  \approx  \tau/9\mu
\end{equation}

où $9m$ est voisin du rapport proton/electron, conformément à \textit{la prédiction d’Eddington, d’une symétrie proton/tau complètement oubliée}, malgré qu’Eddington ait prévu le tau, 30 ans avant sa surprenante découverte, avec une bonne estimation de sa masse. L’ordinateur indique la corrélation, à 4 ppm:
...
Le plus significatif est la relation au ppb :

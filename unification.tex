...
La valeur $\pi_e$ manifeste une rationalisation symbolique de $\pi$, et connecte avec une approximation $\Phi_e$ du nombre d'or:

\begin{equation}
\pi_e = ({q'} sin\theta)^2 a/4 ≈ 3 + 2\p1^2a^3/(137a_0)^2  = 4/\sqrt \Phi_e 
\end{equation}

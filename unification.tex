...
\begin{table}
\caption[Table \ref{tab:1:table1}: Cosmologie Holographique.]{Cosmologie Holographique}
\label{tab:1:table1}
  \hskip-2.0cm\begin{tabular}{lllll}
    ...
    $m_e $ & $m_pm_H$   & $R/2$ demi-rayon de l'Univers & $R/\lambdabar_e \approx g(6) \approx 2^{128}$   & $m_P^4/m_em_pm_H = M$ \\

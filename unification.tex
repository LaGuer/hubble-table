...
ce terme $K_+^{(12)}$ = 1001 = $S_3^{(10)}-2$, le 2 étant encore identifié aux nombre d'opérations triviales. \textit{Cela établit donc une liaison entre les dimensions 26 des cordes et la dimension 10 des supercordes.}

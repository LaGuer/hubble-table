...
La pertinence de la rationalisation symbolique de $\pi$ est confirmée aussi par relation suivante \textit{exhibant directement $\sqrt a$ dans le développement de $\pi$}:

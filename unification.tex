...
A noter la simplicité de la formule empirique de Koide, où $\mu$ et $\ tau$ sont les rapports de masse des fermions muon et tau par rapport à l'électron, qui sont les correspondants de l'électron dans les deux "générations inutiles" des particules. 

Cette relation, liée aux propriétés des "maretrices circulantes", ne reçoit aucune explication dans le modèle standard, qui manifeste, là encore, son insuffisance:

\begin{equation}
(1+\mu+\tau)/2 = (1+\sqrt\mu+\sqrt\tau)^2/3 
\end{equation}

Cette formule s'est révélée prédictive à une époque où la mesure de $\tau$ était fausse de 3 sigmas. La valeur optimale de $\tau$ est déduite de cette formule et de la relation $\mu \approx a\sqrt{(a_w/pH}$ précisant, au ppb près, la mesure, déjà à 10 ppb, du rapport de masse muon-électron.
...
%\begin{equation}
% a_w sin \theta_{\tau} \approx \sqrt P (H/p_W)^4
%\end{equation}

où $p_W = 6\pi^5$ est le rapport de Wyle, avec une valeur de $\pi$ très proche (2 ppb) de la valeur théorique.
...
\textit{Ainsi, la pertinence de la rationalisation symbolique de $\pi$ ne peut être niée.}

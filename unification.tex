...
où ce terme $2a^3/pH$ est lui-même central dans les relations holographique, étant le rapport du rayon holographique réduit du Cosmos sur le demi-rayon de Hubble.
...
\section {et le boson scalaire massif et la relation gravito-électrofaible }
Les masses des bosons W et Z sont reliées à la masse du boson scalaire massif (Brout-englert-Higgs), voir le triangle de Weinberg (Fig). En le complétant par un troisième axe portant l'unité, on obtient un vecteur de module directement lié à la constante holique ci-dessus, où $H$ est remplacé par la masse gravitationnele du proton gravitationnelle $p_G$ ci-dessus:

\begin{equation}
 1 + {q'}^2  + {q''}^2 = 1 + (m_Z/m_{BEH})^2 \approx 2a^3/pp_G
 \end{equation}
 
Avec la valeur optimale de $m_Z$ et la valeur prédite du boson scalaire $ m_{BEH} = 495^2 m_e $,  \cite{Sanchez2}, la précision de cette relation est ($10^{-7})$. 




\section{La reation avec le couplage électrque}
...
\label{tab:1:table1}
 ...
 Planck ratio $m_P/m_e$ & P   & $2.389015907 \times 10^{22}$ & cite{Sanchez2}  \\
 Gravitational proton ratio $P N_L^{-1/2}$ & $p_G$    & $ 1831.531181 $ & cite{Sanchez2}  \\
 Gravitational coupling constant $R/2\lambdabar_e = P^2/pH$ & $a_G$   & $1.691936467 \times 10^{38}$ & cite{Sanchez2}  \\
 Electroweak coupling constant $F^2 = (2\gamma\times 137)^3$ & $a_w$     & $3.283374406 \times 10^{11}$ & cite{Sanchez2}  \\
Optimised Strong coupling constant $a_w/2\pi(pH)^{3/2}$ & $a_s$   & $8.434502906$ & cite{Sanchez2} \\
...
\label{tab:2:table2}
 ...
 Planck length $(\hbar G /c^3)^{1/2}$ & $l_P$  & m  & $1.61639471 \times 10^{-35}$ & cite{Sanchez2}  \\

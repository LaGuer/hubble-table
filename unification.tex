...
Cela montre de façon nette que le cosmos utilise la base $137$. Cela est confirmé par la double relation suivante, impliquant les rapports de masse $p$ proton/électron, $H$ (hydrogène/électron), et $n$ (neutron/électron):

\begin{equation}
 n^3 \sqrt{pH} (\pi/a) \approx  (137^2 \Gamma^3/\sqrt{a_w})^3 \approx  \sqrt{a_w} (\Gamma/ 4)^3
 \end{equation}
...
\begin{equation}
(R/\sqrt{pH}^{1/4}  \approx  WZ \approx (R\lambdabar_e/lambdabar_e/lambdabar_p lambdabar_H W^8)^3 
\end{equation}

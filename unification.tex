...
\node [anchor = east,color=black] at (-12.25,24.250){\LARGE{MICROPHYSICS}};
\node [anchor = east,color=black] at (-12.25,22.250){$y=\ln\ln(\lambdabar_e(n)/\lambdabar_{MICRO})$};
...
\node [anchor = north] at (-31.55, 6.0) {$\pi-1/\phi$};
...
%% SLOPE
\tkzLabelSegment[sloped,below,text=black](B,D){slope $\ln{2}/4$}
\end{tikzpicture}

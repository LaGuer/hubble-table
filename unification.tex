...
\draw [-,color=blue,dashed] (15.25,-32.) node[left]{} -- (15.25,15.25) node[right]{};   % Photon vertical line
%\draw[blue, dotted]
%      let \p1 =  ($(B)-(center)$),
%          \n0 = {veclen(\x1,\y1)}
%      in (center) circle(\n0);
...
\node [anchor = east,color=black!40!green] at (15.25,15.250){$PHOTONDE$};
...
\node [anchor = east,color=black!40!green] at (25.25,25.250){$Super Period$};
...
\node [anchor = south] at (30.2,-36.75) {$d$};
\node [anchor = south] at (31.0,-36.75) {$k$};
%%% Y AXIS
...
\node [anchor = north] at (-34.25,30.0) {$y=\ln\ln(y)$};

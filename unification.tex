...
La masse $b$ de bicodon, relativement à l'électron, donnée par l'Eq. (12), présente un écart $ \approx 4.74941 \times 10^{-4}$, qui est \textit{l'incertitude actuelle des masses isotopiques effective}{} \cite{Wichers}. Plus précisément, à 10 ppm près

\begin{equation}
 b \approx (pn)^4/H^6
 \end{equation}

et, avec la masse de Koide \bibitem{Koide} et $d_e$ l'excès manétique de l'électron:
Elle vérifie, au ppb près:

\begin{equation}
 b \approx (p_K/\sqrt{pH})(p_W d_eo_1/(o_1+1))^2
 \end{equation}
 
faisant intervenir $o_1+1\approx o_2$, ce qui signifie que, en première approximation, la masse du bicodon ne varie au plus que de 3 masses hydrogène: \textit {l'ADN est un calculateur à base 3, comme le Cosmos}. Noter que la base 3 est reconnue comme la base entière la plus efficace. Ce n'est que pour des raisons techniques que l'informatique actuelle n'utilise que la base 2. 

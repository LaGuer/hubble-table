...
$417 = 419 - 2$ est le nombre de symétries positives $10D$ non triviales. Le rapport $419/417$ est voisin de $2^{1/12^2}$, le limma musical repéré en physique des particules \cite{Sternheimer}. La proximité $a_w^{5/2} \approx \Phi^{137}$ a été repérée \cite{Sanchez1}, et ici $ \Phi_a = (4/\pi_a)^2$.

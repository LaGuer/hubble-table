...
\label{tab:2:table2}
 ...
 Adenine-Thymine mass/m_e &  $o_1$   & 612.31268 H & \cite{Huang} \\
 Guanine_Cytosine mass/m_e &  $o_2$   & 613.300194 H & \cite{Huang} \\ 
...
\label{CosmosTable}
 ...
 $ Rl_{nl}^2c^2a_w/R_NGm_{bc} $ & 9.07375 & Principe Holique, avec $m_{ph} = \hbar /cl_{nl}$, $m_{gr} = m_{ph}/a_w$  $m_{bc} \approx 1839.3 ~m_H$ \cite{Sanchez3}   \\

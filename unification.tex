...
$p_{W2}$ = 3511
%$\approx e^{3e}$
is close to the \textit {supersymmetric} couple (meson $\eta$, fermion $\tau$). They connect with the only known couple of Mirimanoff numbers, which uses the base 3, instead of the Wieferich base  2: ($p_{M1}$ = 11,$p_{M2}$ = 1006003 = 1003^2 - 6, where 1003 = $K_9 + K_{10} + K_{11}$ shows up in the Crystallographic Table:

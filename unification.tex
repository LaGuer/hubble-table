...
The Keplerian Diophantine equation shows a symmetry between gravitation and quantum physics, connecting the Bohr’s orbitals with the Permanent Holographic Oscillatory Bang model. The local c-observable base 2 Universe appears as a gauge boson in the base 3 Tachyonic Comsos. The mean DNA bi-codon mass is central and connects to 0.1 ppm with the Topological Axis. This induces a scalar boson mass confirmed both by the geometric extension of the Weinberg triangle and by the 9D crystallographic symmetry, associated to the string dimension reduction. This is tied to the Euler's suitable numbers connecting with the Riemann hypothesis. The running number of the string dimension series of the Topological Axis is identified with the orbital quantum number, associating the spin 1/2 and the string dimension 2. This confirms Eddington, Wyler, Noyes, Atiyah and the Combinatorial Hierarchy, leading to the gauge partition. This excludes the concepts of Multiverse, Continuum, Infinity, Locality and Zero mass Particle, and leads to stringent predictions. 


\end{abstract}

\keywords{Computation Principle \and Holographic principle \and Holic Principle  \and Cosmology \and Number theory  \and String theory \and bit-String theory \and DNA nucleotides \and Crystallographic Symmetry \and Periodic Table \and Sporadic Groups.}
  ...
  \hskip-0.0cm\begin{tabular}{llllllllllllll}
    ...
    $K_d$ (positive $PSO_{Cr}$)  & 1 & 1 & 5 & 5 & 19 & 19 & 59 & 59 & 165 & \underline{165} & 419 & 419 & 1001 \\
     ...
     %$K^{(d)}_-$  &  & 1 & 1 & 5 & 5 & 19 & 19 & 59 & 59 & 165 & 165& 419 & 419  \\
      ...
      $T_d =\sum_{d-1}^{d+1}K_d$ &  & 7 & 11 & 29 & \underline{43} & 97 & \underline{137} & 283 & 389 & 749 & 1003 & \underline{1839} & 2421 \\
...
Note that 495 is the odd part of the first Mathieu group, and the couple 495- 496 is the third perfect couple. In such a couple, the first number is the sum of the \textit{non-trivial} divisors of the second. Since $496 = \binom{32}{2}$ is the dimension number of the group SO(32), and $495 = \binom{12}{4}$ \footnote{Number of groups of 4 elements taken among 12}, this leads to the conjecture : \textit{the perfect couple 495-496 could be the single one implying non-trivial binomial numbers}. This calls for further study. One notes that $N_9 = 330 = \binom{11}{4} = 2 K_9 = 2 \binom{11}{3}$, so:  
...
\textit{It is shown \cite{Weinberger} that a single Euler suitable number could exist, and if no, i.e if $s_0$ is really the maximal one, then Riemann conjecture would be confirmed. So the proton-electron ratio is at the heart of Number Theory.}
\textit{So the string reduction problem is tied to the crystallographic symmetries. This implies the elimination of the continuum in theoretical physics, in conformity with the Computing Principle.} 

This could unblock the present dilemma of string theories which lead to an enormous number $10^{500}$ of solutions for dimension reduction, an anomaly which is claimed to sustain the unscientific Multiverse model.

Moreover the number 1839, which are is the brut neutron/electron masse ratio, appear also in the Table 5.5, and so implies the folowing:

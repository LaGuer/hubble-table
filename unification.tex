...
\subsection{La Relation Centrale}
...
De plus, on observe les relations suivantes entre les trois paramètres de couplages électrique, électrofaible et gravitationnel: (Table \ref{tab:2:table2} ):

\begin{equation}
\eta = (419/417) \approx a_w^{5/2}/ P a^3~~ (1 ~ppb)   \approx e^{1/209} ~~ (10 ~ppb) \approx \Gamma^{1/alna} ~~ (160 ~ppb) \approx 2^{1/12^2} ~~ (30 ~ppm)
 \end{equation}

...
The Holic Principle, which is the simplfied form of the Holographic Principle, based on the simplest degenate Diophantine equations induces an “Hyper-symmetry” between the constants $G$ and $\hbar$ which leads to a new expression of Bohr’s orbits. With the very precise quasar non-local period, this establishes a connection between the Hubble and Cosmos radius of the Permanent Holographic Oscilatory Bang model and their common CMB temperature. The c-observable Universe appears as a Cosmos “immergence”, where the mean DNA bi-codon mass is central, connecting to $10^{-7}$ with the mean dimension 16 of the Topological Axis. Associating computation with symmetry, whose common point is invariance,  multi-dimensional crystallographic symmetries are studied, establishing connetions between the physical parameters, the string theory, the periodic table and the sporadic groups. The Multiverse model is excluded, replaced by the search towards a Science-Arithmetic Unification.  

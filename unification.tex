...
\begin{equation}
3^{10} \approx \pi a^2 \approx \Phi^{137/6} \approx \sqrt{l_{phCMB}/\lambdabar_e}
\end{equation}

involving the Golden ratio in the old chinese musical scale of 60 notes per octavus. The lenth $l_{phCMB} = (hc/k_BT)(16~p_i \khi(3))^(-1/3)$ is the side of a cube containing a single CMB photon. The total number of photons in the Hubble sphere and in the Cosmos shows the particularities (190 and 4 ppm):

\begin{equation}
 \left\{
    \begin{array}{ll}
    n_{phCMB} =  (4\pi/3)(R/(\pi^2a^4\lambdabar_e)^{3/2} exp(e^6/4)\\
    
        N_{phCMB} = (4\pi/3)((R/(\pi^2a^4\lambdabar_e)^{3} \approx (a/137)\pi \sqrt{g_0} (R/\lambdabar_e)^7
...
\begin{equation}
n_{phCMB} = (4\pi/3)(R/(\pia^2)^2)^3 \approx (3/\pi)exp(e^6/2)
\end{equation}

...
The mean nucleotide mass is $ (o_1 + o_2)/4 \approx 306.4032199$, close to $\pi^5 \approx 306.019684$. The mean DNA bi-codon mass, is $m_{bc}^{(0)}/m_H = (6/4)(o_1 + o_2) \approx 1838.418122$, close to $p_W = 6 \pi^5$, the Lenz-Wyler proton-electron mass ratio \cite{Wyler}. Note that the Wyler formula $6\pi^5$ shows a geometric property: it is the product of the area by the volume of a cube of side $\pi$. More precisely, with $n_t/p$ the neutron-proton mass ratio,  $d_e$ the electron magnetic excess, and $f(16)$, the central term of the Topological Axis (150 ppb and 55 ppb):
 
 \begin{equation}
 \left\{
    \begin{array}{ll}
       m_{bc}^{(0)}/m_H = (6/4)(o_1 + o_2) \approx H(n_t/p)^{1/2} \\
       \\

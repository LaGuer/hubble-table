...
Le tableau périodique de éléments, jusqu'à 'Organesson de numéro tomique 118, correspond à la distribution suivante des couches:

\begin{equation}
 \sum_{k=0}^{k=7} c_k d_k = 118 ~~~~ \rightarrow   c_k = (7,6,4,2)
 \end{equation}

La variation d'une unité de $d_k$ conduit à 

\begin{equation}
 \sum_{k=0}^{k=7} c_k (d_k + 1) = 137 = 2^7 + 2^3 + 2^0
 \end{equation}

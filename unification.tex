...
\begin{equation}
 ...
 confirmant que le Cosmos utilise à la fois la base néperienne $e$ et $\pi$. Noter que les séries de Riemann d'ordre paires utilisent effectivement des puissances de $\pi$, qui se comporte donc bien comme base de calcul. 
...
De plus, la masse gravitationnelle du proton $p_G = P/\sqrt {N_L}\approx 1831.531182$, où $N_L$ est le grand nombre de Lucas, le terme terminal de la Hiérarchie Combinatoire \cite{Bastin}, écrite sous la forme de Lenz-Wyler \cite{Wyler}:
...
présente un développement singulier: 

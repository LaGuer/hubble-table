...
title={caracteristics length follow the law $exp(2^{d/4})$, unit length: electron compton reduced wavelength: $\hbarm_ec=\lambdabar_e$}, 
...
\tkzDefPoint(30.25,30.25){N}
\tkzDefPoint(-10.0,-10.0){P}
\tkzDefPoint(31.0,31.0){Q}
\tkzDrawPoints(A,B,C,D,F,E,G,H,I,J,K,L,M,N,P,Q)
...
%\draw [->] (0.0,-32.) node[left]{} -- (0.,0.) node[right]{};   % Bicodon vertical line
\draw [-,color=blue,dashed] (-34.0,-2.4) node[left]{} -- (-2.4,-2.4) node[right]{};   % Scalar Boson horizontal line
...
\draw [-,color=blue,dashed] (4.25,-32.) node[left]{} -- (4.25,4.25) node[right]{};   % Thermal Photon vertical line
\draw [-,color=blue,dashed] (12.25,-32.) node[left]{} -- (12.25,12.25) node[right]{};   % Boson X GUT vertical line
\draw [-,color=blue,dashed] (16.,-32.) node[left]{} -- (16.,16.) node[right]{};   % Photon vertical line
\draw [-,color=blue,dashed] (17.25,-32.) node[left]{} -- (17.25,17.25) node[right]{};   % Galaxy group vertical line
\draw [-,color=blue,dashed] (20.0,-32.) node[left]{} -- (20.0,20.) node[right]{};   % Gravitonde vertical line
\draw [-,color=blue,dashed] (30.0,-32.) node[left]{} -- (30.0,30.0) node[right]{};   % Super Period vertical line
%\draw [-,color=blue,dashed] (17.25,-32.) node[left]{} -- (17.25,17.25) node[right]{};   % Topon vertical line
...
\node [anchor = east,color=black!40!green] at (0.,0.0) {$BICODON$};
\node [anchor = west,color=black!40!green] at (0.,0.0) {$\times 2R_N/R$};
...
\node [anchor = south,color=red] at (17.25,-31.0) {$\Gamma$};
\node [anchor = east,color=black!40!green] at (20.,20.0){$GRAVITONDE$};
\node [anchor = west,color=red] at (20.,20.0){Hubble Radius $/6$};
\node [anchor = south] at (16.25,-33.0) {$24$};
\node [anchor = east,color=black!40!green] at (29.25,29.250){$Super Period$};
\node [anchor = east,color=black] at (30.25,30.250){$TOPON$\tiny{:Visible universe wavelength}};
...
\node [anchor = south] at (30.25,-36.0) {$e^2$};
\node [anchor = south] at (30.25,-33.0) {$2e^e$};
\node [anchor = south] at (31.6,-33.20) {$d$};
\node [anchor = south] at (31.6,-36.75) {$k$};
%%% Y AXIS
...
\node [anchor = north] at (-34.25,32.0) {$y=\ln\ln(y)$};
...
\end{tikzpicture}
\caption[The cG$\hbar$ Triedre]{ Cosmologie Holique : le Triedre $cG\hbar$}
\end{figure}

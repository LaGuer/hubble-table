...
La masse moyenne est 306.4032199, et celle du codon composé de six nucléotides est 1838.418, soit à 0.1 ppm près:

\begin{equation}
 m_{bc}/H = (6/4)(C_y + T_h + A_d + G_u) \approx H\sqrt{n_t/p}
 \end{equation}

\textit{Cette masse du bi-codon correspond au rayon cosmique $R_c$ (eq.12) à $5 \times 10^{-4}$ près}

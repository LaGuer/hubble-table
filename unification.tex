...
\textit { $\sqrt a$ est le terme générateur de l'électrodynamique quantique des diagrammes de Feynman Table \ref{tab:10:table10}}.
...
\begin{table}
\caption[Table \ref{tab:10:table10}: Adimensional primary constants.]{Adimensional primary constants}
\begin{tikzpicture}
  \begin{feynman}
    \vertex (a) {\(\mu^{-}\)};
    \vertex [right=of a] (b);

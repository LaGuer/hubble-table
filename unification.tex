...
\begin{equation}
(Z/W - W/Z)^{-1} \approx (H/p)^2\Gamma \sqrt 2/9 \approx  cos\theta_0 / (sin\theta)^2 \approx cos\theta_0 Z^2 sin\theta / \Gamma \sqrt a_w (a/9)^2
 \end{equation}
 
où $cos\theta_0 = p_0/a e^e $. Mais $cos\theta = (1 - (sin\theta)^2)^{1/2}$ présente un écart de 70 ppb avec $W/Z$, laissant présumer que ce modèle n'est pas complet. En effet l'interaction forte fait intervenir un couplage de jauge $g_3$ du groupe SU(3). Noter que $g_3 = 4\pi_q Z/W\sqrt a \approx 1.218729$ présente identiquement le même écart avec $g_1g_2 \sqrt {a_2}$, où $\sqrt {a_2} = \sqrt a sin\theta $ apparaît ci-dessous. 

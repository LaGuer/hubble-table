...
\begin{equation}
 sum_{k=0}^{k=7} (d_k+1)= 2^7 + 2^3 = 136 = 118 + d_4
 \end{equation}

retrouvant la somme canonique d'Atiyah, intégrant les octonions ($2^7$), et les quaternions ($2^3$). Ce nombre primaire d'Eddington 136 est le nombre d'éléments indépendants dans la matrice symétrique $16\times16$. Il correspond à la suite atomique ci-dessus, augmentée de la couche complète $d_4$ = 18. Cette couche spctroscopique (appelée "g") est effectivement considérée par les chimistes comme devant prolonger la table des éléments.
...
où $\pi_A$ est l'approximation d'Archimèdes, et le terme $10\times11$, caractéristique des dimensions canoniques 10 est 11 est identifié à $7\times16 -2 = d_{27}$.

...
\label{tab:2:table2}
  \hskip-2.0cm\begin{tabular}{llll}
    ...
    Wien factor $ wi = 5(1-e^{-wi})$ &  wi  & 4.96514245  & "exact" \\
  ...
  This work "weak-mixing angle" & $(\sin \theta)^2(m_Z)$    & 0.231475 &  \\
   ...
   Optimized SU(2) gauge coupling &{$q'$}     & 0.6421390034 & 0.15 \\
...
\label{tab:3:table3}
 ...
 %Rydbergh reduced wavelength $\lambdabar_e(2aH/p)^2$ & $\lambdabar_{Ryd}$  & m  & $1.45190673 \times 10^{-8} $ & 0.3   \\
  ...
  %Official CMB temperature & $T_{CMBoff}$ & K & $2.7255(6)$ & $2 \times 10^5$ \\    
   ...
   Cosmos (CMB) Wien wavelength & $\lambda_{CMB}/wi $ & m & $1.063082472  \times 10^{-3} $ & \cite{Sanchez2} \\
...
L'apparition ancestrale du nombre d'or en biologie doit être reconsidérée avec la plus grande attention, mais son role calculatoire n'a apparammet pas été signalé. Malgré la très riche littérature sur les rapport entre les arts graphiques et architecturaux, la corrélation musicale n'a jamais été convainquante. A paet le fait que le grand nombre de la gamme chinoise $3^60 \approx \phi^{137}$, une autre corrélaion apparaot nettement dans cette étude :   essentielle ait échappé: la 




le nomre d'or qui apparait effectivement dans l'axe topologique et intervient par sa puissance holique 210.

...
\begin{equation}
 \left\{
    \begin{array}{ll}
        Cytosine basique ~~^{6}_{12}C_{9}~^{1}_{1}H_{12}~^{7}_{14}N_3~^{8}_{16}O_6~^{15}_{31}P : ~ C_y^{(0)} \approx 286.802335\\
        Thymine basique~~ ^{6}_{12}C_{10}~^{1}_{1}H_{13}~^{7}_{14}N_2~^{8}_{16}O_7~^{15}_{31}P :  T_h^{(0)} \approx301.68554\\
        Adenine basique~~ ^{6}_{12}C_{10}~^{1}_{1}H_{12}~^{7}_{14}N_5~^{8}_{16}O_5~^{15}_{31}P:~  A_d^{(0)} \approx310.62714\\
        Guanine basique~~ ^{6}_{12}C_{10}~^{1}_{1}H_{12}~^{7}_{14}N_5~^{8}_{16}O_6~^{15}_{31}P :   G_u^{(0)} \approx326.497864 
    \end{array}
\right.
\end{equation}

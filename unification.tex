...
\draw [->] (-20.0,-32.) node[left]{} -- (-20.,-10.) node[right]{};   % Bicodon vertical line
\draw [-,color=blue,dashed] (-20.0,-32.) node[left]{} -- (-20.,-10.) node[right]{};   % Bicodon vertical line
...
\draw [-,color=blue,dashed] (17.25,-32.) node[left]{} -- (17.25,17.25) node[right]{};   % Galaxyy group vertical line
...
\node [anchor = east,color=black!40!green] at (19.25,19.250){$GRAVITONDE$};

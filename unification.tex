...
La masse moyenne du bi-codon, composé de six nucléotides est $m_{bc} = (6/4)(o_1 + o_2) \approx 1838.418122$, soit à 0.1 ppm près:
...
La masse de bicodon, donnée par l'Eq. (12), est, relativement à l'élecron, notée $b$, présente un écart $ i \approx 4.74941 \times 10^{-4}$, qui est l'incertitude actuelle des masses isotopiques effectives. Elle vérifie, au ppb près:

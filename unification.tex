...
\draw [-,color=blue,dashed] (30.0,-32.) node[left]{} -- (30.0,30.0) node[right]{};   % Topon vertical line
...
\node [anchor = east,color=black] at (-14.25,24.250){\LARGE{MICROPHYSICS}};
\node [anchor = east,color=black] at (-14.25,22.250){$y=\ln\ln(\lambdabar_e(n)/\lambdabar_{MICRO})$};
\node [anchor = east,color=red] at (20.25,-20.250){\LARGE{MACROPHYSICS}};
\node [anchor = east,color=red] at (20.25,-22.250){$y=\ln\ln(\lambdabar_{MACRO}(n)/\lambdabar_{e})$};
...
\node [anchor = north] at (-34.25,35.0) {$Y=\ln\ln(y)$};

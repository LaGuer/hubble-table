...
\begin{equation}
 1 + 1/q^2 = 1 + 1/{q'}^2 + 1/{q''}^2 = (Z/495^2)^2 + 1 \approx 2a^3/pp_G
 \end{equation}
 
 L'extrème précision de cette relation ($10^{-7})$ confirme la valeur ci-dessus du boson scalaire. Rappelons que le terme $2a^3/pH$ est la clef holique du rayon de Hubble. 

...
\label{tab:5:table5}
  \hskip-2.0cm\begin{tabular}{lllll}
    ...
    $m_{bc}R/R_N $ & $m_{ph}m_{gr}$   & $R_C$ rayon du Cosmos & $ R_C/\lambdabar_e \approx e^{e^{2e}} \approx 6^{128}\approx 3^{210}\approx (2R/R_N)^{64a_s}  $&  $m_P^4/m_{bc}(R/R_N)m_{ph}m_{gr} = M_C $ \\

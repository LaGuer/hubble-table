...
%They connect with the only known couple of Mirimanoff numbers, which uses the base 3, instead of the Wieferich base  2: $p_{M1}$ = 11 and $p_{M2}$ = 1006003 = 1003^2 - 6, where 1003 = $K_9 + K_{10} + K_{11}$ shows up in the Crystallographic Table. One notes:

...
The Holic Principle, based on the simplest Diophantine equations, induces an “Hyper-symmetry” between gravitation and quantum physics, which leads to Bohr’s orbits. The quasar non-local period, the most precise cosmic measurement (10−6), connects with the Hubble radius, the Cosmos radius and their common CMB temperature. This confirms the Permanent Holographic Oscillatory Bang model. The mean DNA bi-codon mass is central and connects to 10−7 with the Topological Axis, which defines a scalar boson mass, connected to the geometric extension of the Weinberg triangle, confirming the G value to 10−7. The multi-dimensional crystallographic symmetries connect the scalar boson with the 9D string dimension reduction. The string dimension series $d = 2 + 4k$ are identified with the Topological Axis dimensions. In the Periodic Table, $k$ is identified with the orbital quantum number, associating the spin 1/2 and the string dimension 2. This confirms the Atiyah and Combinatorial Hierarchy approaches, leading to the gauge partition. This search towards a Science-Arithmetic Unification excludes the concepts of Multiverse, Continuum, Infinity, Locality and Zero mass Particle, leading to stringent predictions. 

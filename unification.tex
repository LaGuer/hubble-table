...
La suite fractionnaire ci-dessus de $\pi$ est un problème non résolu des mathématiques actuelles. Cependant, on note que la partie entière de $\pi_5$, le nombre \doubleunderline{$292$}, déjà rencontré ci-dessus en connexion avec le nombre d'or $\Phi_9$, est la moyenne des nombres de symétries cristallines paires (419) et impaires (265) dans l'espace $10D$ des supercordes \cite{Weigel} \cite{Veysseyre} (Table \ref{tab:4:table4}).

...
\begin{equation}
 \left\{
    \begin{array}{ll}
        Cytosine ~basique ~~^{6}_{12}C_{9}~^{1}_{1}H_{12}~^{7}_{14}N_3~^{8}_{16}O_6~^{15}_{31}P : ~ C_y^{(0)} \approx 286.8021362\\
        Thymine ~basique~~ ^{6}_{12}C_{10}~^{1}_{1}H_{13}~^{7}_{14}N_2~^{8}_{16}O_7~^{15}_{31}P :  T_h^{(0)} \approx301.68553403\\
        Adenine ~basique~~ ^{6}_{12}C_{10}~^{1}_{1}H_{12}~^{7}_{14}N_5~^{8}_{16}O_5~^{15}_{31}P:~  A_d^{(0)} \approx310.6269397\\
        Guanine ~basique~~ ^{6}_{12}C_{10}~^{1}_{1}H_{12}~^{7}_{14}N_5~^{8}_{16}O_6~^{15}_{31}P :   G_u^{(0)} \approx326.4976654 
    \end{array}
\right.
\end{equation}

La masse moyenne est $ (o_1 + o_2)/4 \approx 306.4032199$, où $o_1$ et $o_2$ sont les masses brutes des couples AT et GC 


La masse moyenne du bi-codon, composé de six nucléotides est $m_{bc} \approx 1838.418122$, soit à 0.1 ppm près:

\begin{equation}
 m_{bc}^{(0)}/H = (6/4)(C_y^{(0)} + T_h^{(0)} + A_d^{(0)} + G_u^{(0)}) \approx H\sqrt{n_t/p}
 \end{equation}
 
\textit{Par rapport à la masse donnée par l'Eq. (12), cette masse du bi-codon présente un écart $ i \approx 4.74941 \times 10^{-4}$, qui est l'incertitude actuelle des masses effectives, due aux variations des distributions isotopiques \cite {Wichers}. Cet écart est, à 20 et 2 ppm près, où $d_e$ est l'excédant magnétique de l'électron:

\begin{equation}
 i = m_{bc}^{(th)}/m_{bc}^{(0)} \approx o_2/d_e \approx (1 + 1/o_1) d_e
 \end{equation}

En effet, l'écart $ o_2 - o_1 \approx 0.987521 $ est voisin de 1, de sorte que, en première approximation, la masse du bicodon ne varie au plus que de 3 masses hydrogène: \textit {l'ADN est un calculateur à base 3, comme le Cosmos}. Noter que la base 3 est reconnue comme la base entière la plus efficace, étant l'entier le plus voisin de $e$. Ce n'est que pour des raisons techniques que l'informatique actuelle n'utilise que la base 2.    
...
\bibitem{Koide} Koide Y., Fermion-Boson Two-Body Model of Quarks and Leptons and Cabibbo Mixing  Lett. Nuovo Cimento 34, 201 (1982).{Wichers}


\bibitem{Wichers} Wichers E. et al, https://www.britannica.com/science/atomic-weight (2020).

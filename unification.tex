...
\node [anchor = east,color=black] at (-14.25,24.250){MICROPHYSICS};
\node [anchor = east,color=black] at (-14.25,22.250){\tiny{$y=\ln\ln(\lambdabar_e(n)/\lambdabar_{MICRO})$}};
\node [anchor = east,color=red] at (20.25,-20.250){MACROPHYSICS};
\node [anchor = east,color=red] at (20.25,-22.250){\tiny{$y=\ln\ln(\lambdabar_{MACRO}(n)/\lambdabar_{e})$}};

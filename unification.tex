...
with $\Pi_0 = \lambdabar_e/ \lambda_{\Pi_0}$, and the associated term $\Pi_+$ for the charged Pion, $ p_{hol} = (4 (r_H/\lambdabar_e)^3/3)^{1/2}$ and the $137^{th}$ fibonacci (prime) number:
 \begin{equation}
 \left\{
    \begin{array}{ll}
...
This shows up the above Eq.(32) proving that $\mu_0 = 2\times 3\times 5\times 7 = 210$ is the pertinent arithmetic approximation of $\mu$. With the approximation $\tau_0 = (2+3+5+7) \times 2\times 3\times 5\times 7 $: 
 
\begin{equation}
 (\tau/\tau_0 )^{137} \approx \pi^{\pi}d_e n_t/p   
 \end{equation}

confirming to 20 ppb the Koide tau value \cite{Koide}, where $n_t/p$ is the mass ratio neutron-proton.

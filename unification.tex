...
\begin{table}
%\label{tab:6:table6}
\caption[Table \ref{tab:6:table6}: 21 Hubble radius formulas]{21 formula for $R$}
\label{tab:6:table6}
  \hskip-2.0cm\begin{tabular}{llll}
    \toprule
    \multicolumn{3}{c}{}                   \\
 ...
 $ \lambdabar_{CMB}^6 (sin~\theta)^{2\sqrt a}/R_Cl_P^4$  & 13.81    & Liaison Cosmos-fond de rayonnement \\
 
 
 
 
 $ (l_P/2)(\lambdabar_{CMB}^2\lambdabar_p/lambdabar_{CNB}r_e^2)^6$  & 13.7    & Compémentarité des fonds microondes-neutrinos \\

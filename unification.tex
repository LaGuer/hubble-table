...
Cet article prétend orienter la Recherche vers l'existence d'une Théorie Ultime, unifiant Physique, Arithmétique et Biologie.
...
\label{tab:6:table6}
 ...
 $\sqrt {(\lambdabar_{p} \lambdabar_{H})} (WZ)^4$  & 13.811966    & Précise l relation connue $a_G \approx W^8$ \cite(Rees) \\
 ...
 $(\lambdabar_{e} 2^{128})(1-(137^2+\pi^2+e^2)/pH)$ & 13.81197681 & shows a symmetry between $\pi$, e and 137, prolongating $ a \approx (137^2 + \pi^2)^{1/2}$ \\
   ...
   $ \lambda_{F} P^3/p^7$ & 13.80 & Confirme $p$ come base de calcul  \\

...
\begin{equation}
cos theta_{WZ}/(sin theta_{WZ})^2cos\theta_0 \approx (H/p)^2\Gamma \sqrt 2/9 \approx  1 / (sin\theta)^2 \approx Z^2 sin\theta / \sqrt a_w   \Gamma (a/9)^2 \approx WF 2^{1/2}/3^{1/3}p^2 \Gamma (a/9)^2
 \end{equation}

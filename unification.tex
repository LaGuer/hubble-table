...
A noter que ce nombre $p_G$ se trouve aussi dans le développement suivant de la base naturelle des logarithmes $e : 2, 7/5, -3\sqrt{p_G}$. Ce développement est basé sur l'approximation $e \approx 19/7$, qui connecte avec l'approximation d'Archimède: $\pi \approx 22/7$.
...
\label{tab:2:table2}
 ...
 Optimized Gravitation constant   & G & $kg^{-1} m^3 s^{-1}$  & $6.67545375\times 10^{-11}$  &  ppb \cite{Sanchez2} off. value: $6.67430 \times 10^{-11} \\

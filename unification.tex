...
\begin{equation}
(Z/W - W/Z)^{-1} \approx (H/p)^2\Gamma \sqrt 2/9 \approx  cos\theta_0 / (sin\theta)^2 \approx cos\theta_0 Z^2 sin\theta / \sqrt a_w   \Gamma (a/9)^2 \approx cos\theta_0 WF 2^{1/2}/3^{1/3}p^2 \Gamma (a/9)^2
 \end{equation}

...
En effet, le rapport de cette période avec celle de l’électron $t_e = \hbar/m_ec^2$ est donnée par la plus simple formule éliminant $c$ entre $a_w$ et la constante inverse de couplage gravitationnelle  $a_G = \hbarc/Gm_pm_H$, qui intervient dans le modèle de la molécule gravitationnelle d’hydrogène, où $m_p$ et $m_H$ sont les masses du proton et de l’hydrogène: 

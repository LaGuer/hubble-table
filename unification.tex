...
définit le $\pi$ mathématique à mieux que le ppb. La suite fractionnaire est un problème non résolu des mathématiques actuelles. Cependant on note que le nombre $292$ est la moyenne des nombres de symétries paires (419) et impaires (265) dans l'espace des supercordes $10D$ \cite{Weigel} (table 3).


Avec la valeur de $G$ optimisée par une étude de corrélation \cite{Sanchez} (tableau 2), on observe la relation suivante entre les trois paramètres de couplages électrique, électrofaible et gravitationnel $a, a_w, P$ (table 3):

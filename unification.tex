...
\textit {Un tel Cosmos calculateur devant utiliser des bases de calcul supérieures à l’unité}, les 4 constantes de couplages considérées (électrique, gravitationnelle, faible, forte), $a, a_G, a_w, a_s$ sont ici les inverses des quantités officielles. On y joint la constante $P = m_P/m_e$, le rapport de la masse de Planck sur celle de l'électron, voir en Appendice le bas de la Table \ref{tab:2:table2}). Les constantes \textit{dimensionnées} sont rassemblées dans la Table \ref{tab:9:table9}) \cite{Tanabashi}. 

...
Note that, while $137 = l_{16}$, the $16^{th}$ Lazy Caterer number (maximal number of zones in a plane defined by n lines), $11 = l_4$ and $4 = l_2$. This "arithmetic monster" 137 appears in the Table \ref{tab:4:table4}:

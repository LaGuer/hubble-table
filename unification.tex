...
\begin{table}
%\label{tab:6:table6}
\caption[Table \ref{tab:6:table6}: 25 Hubble radius formulas]{25 formula for $R$}
\label{tab:6:table6}
 ...
 $ 2\hbar^2/Gm_em_pm_H $ & 13.81197676 & Rayon de la Molecule gravitationnelle d'Hydrogene \cite{Sanchez2}   \\
  ...
  $R_C (a_se^{2/a}210^{-210})^{1/8}$  & 13.811982    & A partir du Nombre Holique $210^{210}$, immergence de l'Unives dans le Cosmos \\
  
  
  
  
  $ R_N (\sqrt f(2)/exp(exp(-q''))^{128}(137 p_G/a\sqrt{pn_t})$  & 13.811918    & Symétrie $R_N/R$ suivant parallèle Axe Topologique-charge de jauge $q''$    \\
   
  $ \lambdabar_{CNB}^2 \lambdabar_{CMB}^4 (ln\Phi)^8/l_P^4 R_C H^0 $  & 13.812   & Confirme le boson scalaire $H^0$ et le role de $ln\Phi \approx (\sin \theta_{eff})(m_Z) $ \\

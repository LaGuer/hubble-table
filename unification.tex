...
\end{equation}
 ...
 et, avec la valeur moyenne dans le vide $v ≈ 246 GeV$ :
...
La précision actuelle sur la mesure des masses $W$ et $Z$, de $1.5 \times 10^{-4} et 2.3 \times 10^{-5}$ est insuffisante pour caractériser les approximations de $v$ et $\pi_e$p réalisés dans cette formule. Avec les valeurs optimisées $W ≈ 157340.1093$ et $Z ≈ 178451.7402$  rappelées ci-dessus, on observe que la la valeur $v_0 = 495$ corréle avec le facteur gravitationnel $P$ et la constante d'Atiyah $Gamma$ dansla formule rès symétrique suivante (domaine ppb):
...
\begin{equation}
(W^2a^5137^3/a_w)^7 \approx (Z^6 \sqrt a_w)^3 \approx (1837p/16){3×7} \approx (4 \sqrt a_s)^{3×5×7} 
\end{equation}

...
Le rayon du Cosmos vérifie, à 11 ppm près:

\begin{equation}
(p_G/2an) R_C/\lambdabar_p \approx 3^{210}
 \end{equation}

confirmant que \textit{Le Cosmos utilise la puissance holique 210 de la base entière optimale 3.}

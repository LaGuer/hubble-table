...
with $\Pi_0 = \lambdabar_e/ \lambda_{\Pi_0}$, and the associated term $\Pi_+$ for the charged Pion:
...
\begin{equation}
 ...
 From $O_M^9 \approx \tau^{137}$, the tau value is confirmed to 20 ppb by the following formula, where $n_t/p$ is the mass ratio neutron-proton:

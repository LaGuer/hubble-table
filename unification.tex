...
\node [anchor = text=black] at (-28.,-38.0) {\small{Bosonic string special dimensions: $d=4k+2$ from k=0 to k=7 (Bott sequence). From k= 0 to k = 4, they are the spectroscopic numbers}};

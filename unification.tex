...
% $ \lambdabar_{e} (6/\pi_R)^{r_H/\lambdabar_e}$  & 13.8120    & $137,a,a_w$ : bases de calcul, avec : $\pi_R: 3,7,\sqrt a_w/2\times 137^2$ \\  
 ...
 $ (136/137)2l_{nl}a^3f(16)$  & 13.8120    & Empirical, with the central value $f(16) = e^{16}$ \\ 
  ...
  $ (137^4/ap^2)\lambda_{WCMB}(e^a/4\_pi)^{1/2}$  & 13.8120    & Confirming the Wien CMB wavelength, from $4\pi (R_e/\lambda_{WCMB})^2 \approx e^{a}$ \\ 
...
This confirms the connection $\mu \approx 210$. The $+1/2$ term comes from the dimension $0$, see below, the involved precise value for $\pi$ is very particular, opening future study.  

...
La dimension privilégiée des cordes bosoniques est 26 = 24 + 2, où 24 est le nombre de dimensions transverses. On examine donc le nombre commun $K_{24+} = K_{26-}$ = 76085, pour constater la connexion suivante entre les dimensions 26 et 10, centrales dans la théorie des cordes, à 1.3, 0.5, 3.3 et 5  ppm près:

\begin{equation}
K_{24+} = K_{26-} \approx 1+ \sqrt{417\times 419} (4\pi)^4/137 \approx a q H^4/n_t^3 \approx  K_{26+} tg\theta (Ha^2/p137^2)^2 
\approx K_{26+}(9\mu/\tau) (H/p)^4(H-p)^2 
 \end{equation}

...
The 2 factor comes from the Schwarzschild horizon formula $R_e  = 2GM_N /c^2$, implying the Nambu mass $m_N = am_e$, central in particle physics \cite{Nambu}. \textit{This considers the mass concept as primordial.} 

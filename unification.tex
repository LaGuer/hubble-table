...
où l'on reconnaît le terme $2e^e$ de l'Axe Topologique. L'ordinateur indique les corrélations suivantes, à 70, 20 ppm, 0.6 et 0.5 ppm près, la dernière provenant de $\tau/mu \approx 9 / \tg~\theta \approx \Gamma \sqrt2 \sin~\theta (H/p)^2$ :
\begin{equation}
 \left\{
    \begin{array}{ll}

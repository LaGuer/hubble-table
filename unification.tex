...
((p_G/2an) R_C/\lambdabar_p)^{1/210} \approx 3
 ...
 \textit{Note that 3 is the optimal integer base, the integer closest to $e$} \cite{Hayes}.
...
Note that $N_9$ and $K_9$, as well as $210 = \binom{10}{4}$ are Euler suitable numbers, whose pertnence is confirmed below.
...
Moreover, the numbers 1839, which are is the closest whole value of the proton and neutron/electron masse ratio, appear also in the Table 5.5, and so implies the folowing:
...
%\label{tab:4:table4}
  \hskip-0.0cm\begin{tabular}{llllllllllllll}
    ...
    $N_d$  &1 & 2 & 6 & 10 & 24 & 38 & 78 & 118 & 224 & \underline{330} & 584 & 838 & 1420  \\
       
    $K_d$ (positive)  & 1 & 1 & 5 & 5 & 19 & 19 & 59 & 59 & \underline165 & \underline{165} & 419 & 419 & 1001 \\

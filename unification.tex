...
\node [anchor = east] at (-4.25,-4.25) {HALF MEAN WEAK BOSON};
\node [anchor = west,color=red] at (-4.25,-4.250){HALF RYDBERG WAVELENGTH};
\node [anchor = south,color=red] at (0.,0.0) {$2R_N/R$};
...
\node [anchor = east,color=black] at (-3.55,-3.550){SCALAR BOSON};

...
The Diophantine Kepler law induces an “Hyper-symmetry” between gravitation and quantum physics, connecting between the Bohr’s orbits, the quasar non-local period, the Hubble radius, the Cosmos radius and their common CMB temperature. This confirms the Permanent Holographic Oscillatory Bang model. The mean DNA bi-codon mass is central and connects to 0.1 ppm with the Topological Axis, which induces a scalar boson mass through the geometric extension of the Weinberg triangle. The multi-dimensional crystallographic symmetries connect the scalar boson with the 9D string dimension reduction. In the Periodic Table, the running number of the string dimension series is identified with the orbital quantum number, associating the spin 1/2 and the string dimension 2. This confirms the Atiyah and Combinatorial Hierarchy approaches, leading to the gauge partition. This search towards a Science-Arithmetic Unification excludes the concepts of Multiverse, Continuum, Infinity, Locality and Zero mass Particle, leading to stringent predictions.  

...
The Holic Principle, the simplified form of the Computation and Holographic Principles is based on the simplest Diophantine equations. It induces an “Hyper-symmetry” between $G$ and $\hbar$ which leads to Bohr’s orbits. The the quasar non-local period, the most precise cosmic measurement ($10^{-6}$), connect the Hubble radius, the Cosmos radius and their common CMB temperature. This confirms the Permanent Holographic Oscillatory Bang model (PHOB), the $c$-observable Universe appearing as a cosmic gauge boson. The mean DNA bi-codon mass is central and connects to $10^{-7}$ with the topologic function f(16), where 16 is the mean Topological Axis dimension. The latter defines a scalar BE-Higgs boson mass of $495^2 m_e$, connected to the natural geometric extension of the Weinberg triangle, confirming the $G$ value to $10^{-7}$ precision. The association of Computation with Symmetry leads to the multi-dimensional crystallographic symmetries which explains the term $495^2$, as tied to the 9D string dimension reduction. The string dimension series $d = 2 + 4k$ are identified with the Topological Axis dimensions for the Bott "octonion" series $k= 0 to 7$. For the series $k= 0 to 3$, $k$ is identified with the classical orbital quantum number. This confirms the triple algebra Atiyah series and the Combinatorial Hierarchy, leading to the gauge separation. So, the electron spin 1/2 is associated with the string dimension 2. This search towards a Science-Arithmetic Unification excludes the concepts of Multiverse, Continuum, Infinity, Locality and Zero mass Particle. Stringent predictions concern the very large telescopes in preparation.

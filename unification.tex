...
The number 137 is the Eddington's inverse brute electric coupling. Atiyah recently associated this number with three algebra: the octonion, quaternion and real ones:
...
showing the 11 supergravity dimensions and the usual 4 ones. The number 273 is again one of the Euler's suitable numbers, the closest associated to the prime 137. This number 137 has been unambigously connected with the Lucas-Lehmer series \cite{Sanchez3}. One observes the double apparition of this "arithmetic monster" 137 in the Table 5:

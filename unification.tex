...
\draw [-,color=blue,dashed] (29.0,-32.) node[left]{} -- (29.0,30.0) node[right]{};   % Topon vertical line
...
\draw[color=blue] (A) -- (Y);
\node [anchor = text=blue] at (-8.,34.75) {\Large{TOPOLOGICAL AXIS}};
%\node [anchor = text=blue] at (-10.,32.75) {\tiny{Caracteristics length follow the law $exp(2^{d/4})$}}
\node [anchor = text=black] at (-10.,33.00) {\tiny{Unit length: electron Compton reduced wavelength: $\hbar m_ec=\lambdabar_e$}};
\node [anchor = text=black!40!green] at (-12.,31.75) {\tiny{Super Period unit: $\lambdabar_e/c$. Photonde and Gravitonde masses unit: $2\pi m_N$}};

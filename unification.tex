...
Par contre, ce modèle standard est conforté par la relation suivante, précise à 48 ppm, \textit{compatible avec le rapport de masse $H^0$ du boson scalaire massif}:

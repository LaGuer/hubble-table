...
\begin{equation}
(\Psi\Psi_1)_{mean} = v/\sqrt2 = \mu_0/\lambda
\end{equation}
...
\begin{equation}
\pi_e = ({q'} \sin\theta)^{2} a/4 = 4/\sqrt{\Phi_e}   \approx   3 + 2 \pi^{2a}^{3 / (137a_0)^{2}}   
\end{equation}
...
\begin{equation}
(W^{2a}^{5137}^{3 / a_w})^{7} \approx (Z^{6} \sqrt{a_w})^{3} \approx (1837p/16){3 \times 7} \approx (4 \sqrt{a_s})^{3 \times 5 \times 7} 
\end{equation}

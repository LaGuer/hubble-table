...
\begin{equation}
\lambda_{Wn}/l_P \approx \pi_0^{64}~~~~ \rightarrow  ~~~~ \pi_0 : 3, 7, 16, 1, (W_+ + W_-)/Z ~~~~ (W_+ + W_-)/Z = 2W/Z \approx (4\pi/\sqrt a)^8
\end{equation}
...
\tkzLabelSegment[left,text=blue](H,E){\large $\approx \tau \approx aa'sin(2\theta)$

...
Note that, while $137 = l_{16}$, the $16^{th}$ Lazy Caterer number (maximal number of zones in a plane defined by n lines), $11 = l_4$ and $4 = l_2$. The corresponding Pythagorean tiangle has the perimeter $K_9$ and the area 10 s_0:
 
 \begin{equation}\label{Eq27} and 
 P_{137} = K_9 = 330 = 137 + 105 + 88
 A_{137}  = 14 P_{137} = 10 s_0
 \end{equation}

this relates the 9D crystallography with the maximal Euler number s_0. Note that the numbers 88,105,137 are the number of partitions with elements greater than 1 of 18, 19 and 20, opening further study.

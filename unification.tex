...
\begin{equation}
K_+^{(12)}^2 + 1/(sin_P\theta)^2 \approx /\Gamma F/a sin_P\theta)^3 \approx (9Z)^2/a^3     ~~~~ \rightarrow ~~~~ 1/(sin_P\theta)^4 \approx P/a_w^{3/2} 
 \end{equation}

ce qui lie la masse du boson $Z$ aux couplages grave et faible, via la constante d'Atiyah $Gamma$.  

...
\begin{equation}
 \left\{
    \begin{array}{ll}
        m= m_e;~~ m_{\hbar}^2 = m_pm_H ~~~~ \rightarrow r_1 = R/2 \\
         m = m_G = m_{\hbar} = m_N  ~~~~ \rightarrow r_1 = R_N/2  
    \end{array}
\right.
\end{equation}
...
\textit{La cosmologie est liée au couple $G,\hbar$, voir le trièdre des constantes} (fig).

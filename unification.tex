...
L'ordinateur indique la corrélation suivante, considéré comme précisant $Z$, où $p_0 = 1831$ est la valeur primaire de $p$, comme justifié ci-dessous :
...
Le groupe SU(5) devrait être impliqué. En effet, l'ordinateur indique : $WZ/(Z^2-W^2) \approx \Gamma \sqrt 2 (H/3p)^2 = u$, et la corrélation suivante précise la valeur de $(Z/W)^5$:

\begin{equation}
 (uZ/W)^5 = p_0 (p^3/Hp_W^2)^2 
 \end{equation}

conduisant à $W \approx 157340.0989$, d'où $g_2 \approx  0.642138961$ et $g_1 \approx 0.3436255238 $

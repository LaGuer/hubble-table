...
où $l_P^2/r_e^3$ est le demi-rayon holographique du Cosmos, corresondant à l'élimination de $c$ entre la longueur de planck $l_P$ et le rayon classique de l'électron $ r_e = \hbar/am_ec$, ce qui introduit la masse de Nambu $m_N = am_e$, centrale en physique des particules.

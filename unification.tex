...
\begin{table}
\caption[Table \ref{CosmosTable}: 26 Cosmos radius formula]{26 formula for the Cosmos radius $R_C$}
\label{CosmosTable}
  \hskip-2.0cm\begin{tabular}{lll}
    \toprule
   % \multicolumn{3}{c}{}                   \\
 ...
 $ e^{\mu} l_{phCMB e/2\beta^2 ((a-136)p_t/p_{t0})^2$ & 9.07573 & confirms the CMB temperature invariance, through its photon length $l_{phCMB}$\\

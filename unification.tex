 ...
 \left\{
    \begin{array}{ll}
        ...
        \\
         ...
         Adenine : ~~~ C_{10}^{(0)}~H_{12}^{(0)}~N_5^{(0)}~O_5^{(0)}~P^{(0)}:~  A_d^{(0)} \approx310.6269397 \approx \sqrt {a_w} /p(d_e)^{4}\\
         
         \\
        
         Guanine : ~~~~ C_{10}^{(0)}~H_{12}^{(0)}~N_5^{(0)}~O_6^{(0)}~P^{(0)}(170 p + 159 n_t) :   G_u^{(0)} \approx326.4976654 \approx 495 \approx Zp/2H\Pi_+\\

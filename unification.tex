...
\textit{Par rapport à la masse donnée par l'Eq. (12), cette masse du bi-codon présente un écart $ i \approx 4.74941 \times 10^{-4}$, qui est l'incertitude actuelle des masses isotopiques effectives}. Cet écart est, à 2 ppm près:

\begin{equation}
 i = m_{bc}^{(R_c)}/m_{bc}^{(0)}  \approx (1 + 1/o_1) d_e
 \end{equation}

Or l'écart $ o_2 - o_1 \approx 0.987521 $ est voisin de 1, de sorte que, en première approximation, la masse du bicodon ne varie au plus que de 3 masses hydrogène: \textit {l'ADN est un calculateur à base 3, comme le Cosmos}. Noter que la base 3 est reconnue comme la base entière la plus efficace. ce n'est que pour des raisons techniques que l'informatique actuelle n'utilse que la base 2.  

...
\section{L’unification Physique-Arithmétique}

F.M. Sanchez, M. Grosmann, D. Weigel, R. Veyseyre, L. Gueroult

\subsection{Abstract}

The hypothesis that the Cosmos is a computer leads to a reunification of Arithmetics and Physics, through a systematic optimisation and symbolic rationalisation process, the later being a kind of renormalisation, in the sense that this minimizes the number of parameters. With the optimal ppb values of the electroweak boson masses, and using the Eddington-Atiyah number 137, this permits to validate the Brout-Englert-Higgs mass as $495^2 m\e$, while the weak mixing angle is related to the mass ratio Planck/electron and with the Lucas-Lehmer generator. The symbolic rationalisation confirms also the ppb precise $(10^{-9})$  Hubble radius of the coherent cosmology, rehabilitating the Wyler's theory and the empiric simple Koide formula, also associated with a $\pi$ symbolic rationalisation. 

...
The Holic Principle (HP), the simplified form of the Computation and Holographic Principles (HP*) is based on the simplest degenerated Diophantine equations. It induces an “Hyper-symmetry” between the universal constants $G$ and $\hbar$ which leads to a new expression of Bohr’s orbits. With the cosmic most precise measurement ($10^{-6}$), the quasar non-local period, the Holic Principle shows a connection between the Hubble radius, the Cosmos radius and their common CMB temperature. This confirms the Permanent Holographic Oscillatory Bang model (PHOB). The $c$-observable Universe appears as a cosmic gauge boson in the Topological Axis. The mean DNA bi-codon mass, central in the cosmic-holic formulation, connects to $10^{-7}$ with the topologic function f(16), where 16 is the mean Topological Axis dimension. The latter defines a scalar BE-Higgs boson mass of $495^2 m_e$, connected to the natural geometric extension of the Weinberg triangle, confirming the $G$ value to $10^{-7}$ precision, at $ + 7.7~ \sigma $ of the official value. The association of Computation with Symmetry, whose common point is invariance, leads to consider the multi-dimensional crystallographic symmetries. This is characterised by a function which shows the crystallographic origin of the term $495^2$, tied to the 9D string dimension reduction. The string principal dimension series $d = 2 + 4k$ are identified with the dimensions of the Topological Axis for the Bott "octonion" series 0 to 7. For the partial series, from 0 to 3, $k$ is identified with the classical orbital quantum numbers of the Periodic Table. This leads to confirm both the triple algebra Atiyah series $137 = 2^7 + 2^3 + 2^0$ and the Combinatorial Hierarchy $137 = 3 + 7 + 127$, leading to the raw gauge separation 137 = 30 + 107. So, the electron spin 1/2 is associated with the string dimension 2. The underlying Computation Principle excludes the concepts of Multiverse, Continuum, Infinity, Locality and Zero mass Particle, to be replaced by the search towards a Science-Arithmetic Unification. Stringent predictions are deduced, in particular for the very large telescopes (VLT) in preparation.

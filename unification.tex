...
\begin{table}
%\label{tab:6:table6}
\caption[Table \ref{tab:6:table6}: 33 Hubble radius formulas]{33 formula for $R$}
\label{tab:6:table6}
 ...
 $ R/\lambdabar_e  \approx 6H (2\pi_R a^3)^5 $& 13.81197676    &  Holographique, avec     $\pi_R = 3 + 1/(7+1/(16+2/e^{2e}))$\\
 ...
 $ (\lambdabar_{p} \lambdabar_{H})^{1/2} a_w^4 a^{14}/137^{16}$  & 13.8187    & $137,a,a_w$ : bases de calcul \\  

...
\label{tab:1:table1}
  \hskip-2.0cm\begin{tabular}{lllll}
    ...
    $m_N $ & $m_N^2$   & $R_N/2$ demi-rayon de l'hologramme du Cosmos & $R_N/\lambdabar_e \approx (3^3)^{3^3}$&  $m_P^4/m_G m_{\hbar}^2 = M_N$ \\
    $m_{bc} $ & $m_{bc}^2$   & $2l_{cc}$ double longueur non-Doppler & $ l_{cc}/\lambdabar_e \approx \pi^{50}$&  $m_P^4/m_{bc}^3 = m_{ph} = a_w m_{gr}$  \\
    $m_e $ & $m_pm_H$   & $R/2$ demi-rayon de l'Univers & $R/\lambdabar_e \approx g(6) \approx 2^{128}$   & masse associée $m_P^4/m_em_pm_H = M$ \\

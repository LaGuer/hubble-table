...
La symétrie de cette double relation unificatrice, où les quatre forces sont rerésentées, garantit sa pertinence. On note le rôle central de $495 \Gamma$, ce qui montre une iason intime enre le boson BEH et la constante d'Atiyqah.Le terme ${q''} \approx a_s^{-1/2}$ est lié à l'interaction forte. Le terme $p_E^approx 1847.599459$ est le rapport des solutions de l'équation d'Eddington. La relation $Pp_E \approx (r_H/\lambdabar_e)^{12} = (aH/p)^{12}$, où $r_H$ est le rayon de Bohr, induit l'étude de ce dernier facteur. En effet l'expression symétrique $(r_H/\lambdabar_e)^{12}Rl_K/O_B^2$, où $O_B$ est l'ordre du Bébé_Monstre, corrèle à 50 ppb avec les quantités ci-dessus au degrè polynomial 2. 

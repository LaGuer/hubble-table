...
\textit{It is shown that a single Euler suitable number could exist, and if no, i.e s_0 is really the maximal one, then Riemann conjecture would be confirmed\cite{Weinberger}. So the proton-electron ratio is at the heart of Number Theory.}

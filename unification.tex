...
ce qui semble impliquer une interaction entre la matrice d’espace-temps $4 \times 4$ et la matrice $5 \times 5$ En effet, d’après Salingaros: 

\textit{Indeed, it seems that Eddington was really ahead of his time : Eddington anticipated results of current interest. He discovered the Majorana spinors, and was responsible for the standard 
%\gamma^5$ 
notation as well as the notion of chirality. Furthermore, Eddington deﬁned Cliﬀord algebras in eight and nine dimensions which are now appearing in grand uniﬁed gauge and supersymmetric theories. A point which Eddington cleared up, yet is still misunderstood, is that the Dirac algebra corresponds to a ﬁve-dimensional base space}.

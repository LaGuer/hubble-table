...
\textit{It is shown \cite{Weinberger} that a single Euler suitable number could exist beyond $s_0$, and if not, i.e. if $s_0$ is really the maximal one, then Riemann conjecture would be confirmed. So the proton-electron ratio is at the heart of Number Theory.}
...
Note that another special partition is $137 = 5\times 3^3 + 2$, where $5$ and $3^3$ are the co-perfect numbers of $6$ and $28$. The base 3 relation with $s_0$ follows 

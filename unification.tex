...
R_c = R_e^2/2l_P \approx 2^{128} l_P (Rg_0/ \lambdabar_H)^2 \approx 9.075773 \times 10^{86} m 
 ...
 \textit{The Table \ref{CosmosTable} presents 23 formula confirming this Cosmos radius.}
...
\begin{table}
\caption[Table \ref{CosmosTable}: 23 Cosmos radius formula]{23 formula for the Cosmos radius $R_C$}
\label{CosmosTable}
  \hskip-2.0cm\begin{tabular}{lll}
    \toprule
   % \multicolumn{3}{c}{}                   \\

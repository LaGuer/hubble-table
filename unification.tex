...
où l'on reconnaît le terme $2e^e$ de l'Axe Topologique. L'ordinateur indique les corélations suivantes, à 70, 20 ppm, et 0.6 ppm près:
\begin{equation}
 \left\{
    \begin{array}{ll}
        137 \approx {a'}a^3/\sqrta_w \approx \tau/{a'} sin~(2\theta)\\
2\times 30\times 31 +1 \approx a e^e cos~\theta 
    \end{array}
\right.
\end{equation}

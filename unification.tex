...
\label{tab:3:table3}
 ...
 %Rydbergh reduced wavelength $\lambdabar_e(2aH/p)^2$ & $\lambdabar_{Ryd}$  & m  & $1.45190673 \times 10^{-8} $ & 0.3   \\
  ...
  %Official CMB temperature & $T_{CMBoff}$ & K & $2.7255(6)$ & $2 \times 10^5$ \\    
   ...
   Single Electron Universe length & $R_1$ & m & $1.4923654723 \times 10^{26} $ & \cite{Sanchez2} \\ 
...
\begin{table}
%\label{tab:6:table6}
\caption[Table \ref{tab:6:table6}: 14 Hubble radius formulas (unité : Ga-l){14 formula for $R$ (unité : $10^9 a-l$)}
\label{tab:6:table6}
  \hskip-2.0cm\begin{tabular}{llll}
    \toprule
    \multicolumn{3}{c}{}                   \\
 ...
 $ 2\hbar^2/Gm_em_pm_H $ & 13.81197676 & Rayon de la Molécule gravitationnelle d'Hydrogene  \\
 
 $ R_1 d_e^2(3/2)^{-1/3} \lambdabar_{e} $ & 13.812 & Confirme $R_1$, le rayon mono-électronique de l'Univers  \\
 
 $ \sqrt{2R_1R_N/3} $ & 13.80 & Confirme $R_1$ et le rayon holographique $R_N$  \\
 
 $sqrt{2l_{cc}^3/r_e}  $ & 13.75 & Relation holographique confirmant la longueur non-Doppler $l_{cc}$  \\
 
 $ (r_e^2R_C)^{2/3}/l_{cc} $ & 13.70 & Confirme le rayon du Cosmos $R_C$  \\
 ...
 %$(\lambdabar_{e} 2^{128})(1-(137^2+\pi^2+e^2)/pH)$ & 13.81197681 & shows a symmetry between $\pi$, e and 137, prolongating $ a \approx (137^2 + \pi^2)^{1/2}$ \\
   ...
   $ (2\lambdabar_{e}/3) (\lambdabar_{CMB}/\lambdabar_{H_2})^2$ & 13.90 &  Holographie dans la molécule gravitationnelle d'hydrogène \\
     ...
     $ \sqrt{a-136}(\lambdabar_{CNB}\lambda_{CNB}/\lambda_{CMB})^4 /\lambdabar_{e}^3$ & 13.812 &  Empiric \\
      ...
      $ 3\sqrt{a-136} R_N/4$ & 13.821 &  Empiric \\

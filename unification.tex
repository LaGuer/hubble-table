...
Les masses brutes (excluant les isotopes) des 4 nucléotides de la molécule d'ADN, sont, rapportées à la mase de l'hydrogène \cite{Huang}:
...
\begin{equation}
 \left\{
    \begin{array}{ll}
        ...
        Couple AT~masse~brute~~ o_2 \approx  612.299802
    \end{array}
\right.
\end{equation}
...
La masse moyenne du bi-codon, composé de six nucléotides $m_{bc}/m_H = (6/4)(o_1 + o_2) \approx 1838.418122$  est donc voisine de $p_W = 6 \pi^5$, le rapport de masse proton-electron de Lenz-Wyler \cite{Wyler}. A 0.1 ppm près:
...
La masse $b$ de bicodon, relativement à l'électron, donnée par l'Eq. (12), présente un écart $ 5 \times 10^{-4}$, qui est \textit{l'incertitude actuelle des masses isotopiques effective}{} \cite{Wichers}. Plus précisément, à 10 ppm près:

...
Mais la Science se caractérise par l'existence de lois de conservation, aussi bien en physique qu'en biologie. Les théoriciens associent conservation et symétrie, mais plus fondamentalement, \textit{conservation implique calcul, ce qui justifie la primauté de l'Arithmétique}. Cela élimine l'hypothèse centrale de la physique classique, et qui nuit aux fondements mêms des théories de cordes, l'hypothèse du continu, et donc justifie l'apparition de phénomènes quantiques.
 
Cet article prétend montrer la voie vers l'unification Physique-Biologie-Arithmétique.

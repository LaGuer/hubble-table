...
\section{L'inexplicable périodicité des décalages Doppler} 
...
Cette singularité n'est pas unique: elle implique que le nombre de premiers dans la suite de Fibonnaci pourrait ne pas être infini: c'est un problème non résolu.
...
\section{L'inexplicable période non-Doppler des quasars}
...
La complexité de la structure de l'espace-temps est trahie par le phènomène décrit dans la section suivante, tellement hors-norme qu'aucun physicien n'y a prété attention. Seul Pecker a fait publier les travaux de Kotov et Lyuty \cite{Kotov1}.

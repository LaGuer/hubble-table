...
définit le $\pi$ mathématique à mieux que le ppb. La suite fractionnaire de $\pi$ est un problème non résolu des mathématiques actuelles. Cependant on note que le nombre $292$ est la moyenne des nombres de symétries paires (419) et impaires (265) dans l'espace des supercordes $10D$ \cite{Weigel} (table 1).
...
La table 4 présente 20 formules au ppb pour ce rayon de Hubble. Cette démrche rappelle celle de Jean Perrin qui en présentant 14 formules impliquant des nombes de molécules a convaincu la communauté de l'existence réelle ds atomes.
...
\section{L'immergence des particules contre l'émergence de l'espace-temps}
...
\bibitem{Seiberg} Emergent Spacetime. The Quantum Structure of Space and Time, Proccedings of the 23th Sovay Conference on Physics, Brussels, Belgium, ed. David Gross, Marc Henneaux and Alexander Sevrin, World Scientific, Dec. 2005, 163-178.\\

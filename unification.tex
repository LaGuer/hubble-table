...
où $m_P$ est la masse de Planck. Avec la valeur du boson scalaire $ m_{BEH} = 495^2 m_e $, on obtient une valeur de $m_Z$ à $10^{-7}$ de la valeur précédemment optimisée  \cite{Sanchez2} (Table \ref{tab:2:table2}). 
...
\bibitem{Rees} Rees M. "Cosmic Coincidences: Dark Matter, Mankind, and Anthropic Cosmology" (co-author John Gribbin), 1989, Bantam; ISBN 0-553-34740-3  \\

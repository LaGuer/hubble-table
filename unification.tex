...
L'étude d'Hermann a été complétée et généralisée par l'équipe de Weigel \cite{Weigel}, (table 6.7). On constate que la demi-somme des termes jusqu'à 118 (d = 7) est  $137 + 3/2$, alors que $137$ est la somme des termes de dimensions 5, 6 et 7. Cela devrait être relié à la réduction dimensionnelle de la théorie des cordes pour privilégier l'espace-temps à 4 dimensions. La demi-somme jusqu'à d = 12 est 1836.5, soit avec $m_e = 1$ la moyenne proton-électron, tandis que la somme des termes pour la triplette 10,11,12 est 1839, voisin de la masse du neutron. Cela confirme la pertinence des dimensions particulières 10 et 11 de la théorie des supercordes. La dimension 12 n'est pas prévue par cette théorie, mais c'est la moitié des 24 dimensions transverses de la théorie bosonique, réhabilitée par l'Axe Topologique.

L'ordinateur indique les relations suivantes, dans le domaine du ppb, impliquant les termes $K^{(3)} = 10, K^{(5)} = 38, K^{(9)} = 330$ : 
...
Le nombre de symétries impaires 165 en dimension 10 est le même que le nombe de symétries paires en dimensions 8 et 9. Cela devrait être relié au repliement des dimensions pour passer de la dimension 10 des supercordes à la dimension 4 de l'espace-temps usuel. Ce nombre 165 est liè à la fois à la dimension 496 des supercordes, au boson de Higgs, dont la masse est supposée $(495)^2 m_e$, où $495 = C_{12}^4$ et au premier groupe de Mathieu, d'ordre $O_1 = 7920$:

...
The equivalent relation for dimension 4 shows up a relation between the brut proton-electron mass ratio $1836$ with the Euler maximal suitable number $s_0 = 1848$: 
...
The maximal Euler's suitable number  is very close to the Eddingtons's prediction \cite{Eddington} for the proton/electron mass ratio, $1847.599459$, as the ratio of the roots of the equation $10x^2 - 136 x + 1 = 0$. 
...
\textit{It is shown that a single Euler suitable number could exist, and if no, i.e if $s_0$ is really the maximal one, then Riemann conjecture would be confirmed\cite{Weinberger}. So the proton-electron ratio is at the heart of Number Theory.}

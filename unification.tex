...
In parallel, the string theory favor the Multiverse thesis, a renunciation to the ancestral research for Unity. The observed “fine-tuning”, so favourable to Life, is then justified by the “anthropic principle”, borning to say that the existence of a world where we can live is statically possible. Moreover, the \{single} argument to justify the famous correlations between the great numbers observed by Eddington and Dirac \cite{Sanchez4} is precisely of the same “anthropic” type: in the frame of the evolutive standard Cosmology, we would live a particular cosmic moment where the supposed age of the Universe should be \textit {comparable} a star lifetime able to spread necessary atoms on the space \cite{Rees}.

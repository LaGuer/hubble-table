...
\label{CosmosTable}
 ...
 $ \lambdabar_e e^{e^{2e}+1}/2\pi $ & 9.11 & base naturelle $e$ dans l'Axe topologique\\
  ...
  $ \lambdabar_e e^{(p_0+1/2)/8} $ & 9.09 & base naturelle $e$ \\
 ...
 $l_P(p/H) (R \Pi_{26}/R_N)^{1/3} $ & 9.07579 & Pertinence du produit des ordres des 26 groupes sporadiques \cite{Sanchez2}  \\ 

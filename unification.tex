...
\subsection {Le modèle élecrofaible}
...
\begin{equation}
2 a_s \approx \beta^4 \sqrt{g(1)\tau/\mu}  
\end{equation}
...
et la charge électrique est, où $u_0$ = 5, $d_0$ = 6 sont les masses représentatives des quarks up et down \cite{Sanchez1}:

\begin{equation}
q = {q'} \sin\theta = {q''} \cos\theta =  \approx 0.302973211 \approx u_0^2d_0/495
\end{equation}

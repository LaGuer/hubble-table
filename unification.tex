...
\title{Permanent Cosmology and Unification}
...
\section{La rationalisation symbolique de $\pi$} 
...
\section{La question de l'espace-temps 4D}
...
\section{Le rayon de Hubble \textit {invariant}}
...
\section{Les fermions primaires, le muon et le tau liés par la relation de Koide}
...
\section{Le boson de Brout-Englert-Higgs}
...
\section {La relation gravito-électrofaible }
...
\section{La connexion avec le générateur de Lucas-Lehmer}
...
\section{La connexion avec la table périodique des élements}

...
L'assimilation à un ordinateur de l'Univers, considéré comme un trou-noir d'horizon $R$, est un sujet actuel très controversé. \cite{Sanchez3}. 
En particulier, Y. Ng \cite{Ng}a cru pouvoir conclure à une mousse quantique dont la dimension est beaucoup plus grande que la longueur de Planck $l_P$,potentiellement mesurable par les détecteurs d'ondes gravitationnelles.Mais cette longueur $(Rl_P^2)^{1/3} \approx 10^{-15} $ m est variable en cosmologie standard,où $R$ est censé augmenter. Par contre, dans la Cosmologie Permanente \cite{Sanchez2}, où l'horizon $R$ est invariant, on peut lier cette distance avec le rayon classique de l'életron $r_e$. On définit ainsi le "rayon de Nambu" $R_N$, lié à la masse de Nambu $m_N = am_e$(le facteur 2 venant de la relation de Shwarszchild $R_N  = 2GM_N /c^2$): 

\begin{equation}
R_N = 2r_e^3/l_P^2 = 2 \hbar^2/Gm_N^3 ~~~~ M_N = m_P^4/m_N^3
 \end{equation}
 
 Ce rayon $R_N$ est légèrement supérieur à l'horizon $R$ de l'Univers, et est considéré comme le rayon holographique du Cosmos, comme rappelé ci-dessous. 

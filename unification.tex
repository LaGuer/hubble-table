...
\textit{ In this manner, in conformity with the standard model, $g_3$ is connected with the strong coupling constant, but through the Wien factor which is not pertinent in the present standard model, but seems central in cosmology, see the Hubble Table and the Cosmos Table \ref{CosmosTable} which presents 23 formula confirming this Cosmos radius.}  

...
The Holic Principle is the simplified form of the Holographic Principle and based on the simplest degenate Diophantine equations. It induces an “Hyper-symmetry” between the constants $G$ and $\hbar$ which leads to a new expression of Bohr’s orbits. With the cosmic most precise measurement, the quasar non-local period, this shows a connection between the Hubble rdius, the Cosmos radius and their common CMB temperature. This confirms the Permanent Holographic Oscilatory Bang model, the c-observable Universe appearing as a cosmic gauge boson. The mean DNA bi-codon mass is central, connecting to $10^{-7}$ with the mean dimension 16 of the Topological Axis. The later defines a scalar boson mass of $495^2m_e$, connected to the natural geometric extension of the Weinberg triangle, confirming the $G$ value to $10^{-7}$ precision, at $+ 7.7~ \sigma$ of the official value. The association of computation with symmetry, whose common point is invariance, leads to consider multi-dimensional crystallographic symmetries. This is characterised by a function which shows the origin of the term 495^2, tied to the 9D string dimension reduction. The string principal dimension series $d = 2 + 4k$ are identified with the dimensions of the Topological Axis 
for the Bott "octonion" series 0 to 7. For the partial series, from 0 to 3, they are identified with the classical orbital quantum numbers of the Periodic Table. This leads to confirm both the triple algebra Atiyah series $137 = 2^7 + 2^3 + 2^0$ and the Combinational Hierarchy $137 = 3 + 7 + 127$, leading to the brute gauge separation 137 = 30 + 107. Then, the electron spin 1/2 is associated with the string dimension 2. The underlying Computation Principle excludes the concepts of Multiverse, Continuum, Infinity, Locality, Zero mass Particle, to be replaced by the search towards a Science-Arithmetic Unification. Stringent predictions are deduced, in particular for the very large telescopes in preparation.  

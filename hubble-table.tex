...
\begin{table*}
  \hskip 1.5cm\begin{tabular}{llllllllllllll}
    \toprule
...
\begin{itemize}
\item [A1] See Table section \ref{tab1:table1} 40 formulas for the Hubble radius with 1\% precision.
\item [A2] See Table section \ref{tab2:table2} 22 formulas for Hubble radius with $2.10^{-4}$ precision.

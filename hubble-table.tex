...
\begin{table}
\caption{11 ppb precise formula for $R \approx 13.8119768$ Glyr}
\label{tab:6:table6}
  \hskip-2.0cm\begin{tabular}{llll}
    \toprule
    \multicolumn{3}{c}{}                   \\
    ...
    \midrule
     ...
     11 & $ a/\Gamma \lambdabar_{e} \sqrt{a_s O_M O_B/(lnP)^{p_W-2}}  $ & 13.81198 & confirms the Atiyah's ratio $\pi/\gamma = a/\Gamma$  \\

...
\centering
%% \includegraphics[width=\textwidth,height=14cm]{./figure/figure}
%%\caption[The Hubble Radius]{Table of Hubble Radius values.}
\begin{axis}
	\addplot+[only marks,
			samples=15,
...
\centering
     ...
     \begin{axis}[
     title={Plot of the Hubble Radius: $R$ Measured vs. Theoritical};
     xlabel={Gly};
     ylabel={10^{26}m};
     ...
     coordinates {
       ...
       (13.75,0.018) +- (0.01,0.0045)
       (-13.75,-0.018) +- (0.01,-0.0045)
       (13.79,0.029) +- (0.01,0.00725)
       (-13.79,-0.029) +- (0.01,-0.00725)
       (13.80,0.035) +- (0.01,0.00875)
       (-13.80,-0.035) +- (0.01,-0.00875)
     };
     \end{axis}
\end{tikzpicture}

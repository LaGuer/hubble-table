...
Atiyah remarked that the couple $137,a$ shows $a^2 - 137^2 \approx \pi^2$, and that his constant involves $a/\pi$, so one considers the equation

\begin{equation}
 (a/\pi_a)^2 - (137/\pi_1)^2 = 1
\end{equation}  
 
with the well-known approximation $\pi_1 = 355/113$, corrsponding to the fractionnal series $3,7,16$ one finds that
$\pi_a$ corresponds to the series $3,7,16,-3\sqrt{137a}/2$, which in turn favors for $\pi_1$ the series  $3,7,16, 1-5a$ 
...
\label{tab:1:table1}
 ...
 First generation (Mathieu) product $\approx e^{68.8957364082420507}$ & $\Pi_{1}$   & $ M_{11} M_{12} M_{21} M_{22} M_{23}$    & exact \\
 
 Second generation product $\approx e^{179.541794334944999}$ & $\Pi_{par}$   & $J_2 ~~HS~~McL~~Suz~~CO_3~~CO_2 ~~CO_1     $    & exact \\
 
 Third generation product $\approx e^{426.083498006426259 }$ & $\Pi_{3}$   &$ F_1 F_2  F_{i24}F_{i23}F_{i22}F_3F_5F_7$    & exact \\
  ...
  Happy Family order product $\approx e^{674.521028749613309} $   & $\Pi_{hap}$   &$2^{301}\cdot 3^{142} \cdot 5^{57} \cdot 7^{30} \cdot 11^{18} \cdot 13^{10} \cdot 17^5 \cdot 19^4 \cdot 23^9 \cdot 31^3 \cdot 47\cdot D $  & exact \\
      ...
      26 sporadic group order product $\approx e^{841.2869278}$  & $\Pi_{26}$    & $\Pi_{hap} \times \Pi_{par}$ & exact \\ 

...
\section{The scope and method}
   ...
   Note that the Topological Axis shows clearly the eight-fold Bott periodicity, typical of octonion algebra, and that Coherent Cosmology seems to involve the sporadic groups. This connection will be strengtened by a more attentive study of the modular function, clrarly tied to the Monster group, the lrgest of the 26 sporadic ones \cite{Conway} \cite{Borcherds}.
   
   
   This article will show also the unexpected laison between the Topologcal Axis and the Periodic table of elements, and the hight-dimension crystallograpjy.
...
As in the preceeding case, this is a symbolic rationalisation. This is the single formula obtained by computer in this article, exept the ppb precise relations involving the Atiyah constant in the Table 6.
...
\listoftables{Tables}   % table des tableaux

%\begin{itemize}
%\item [table1]  Table \ref{tab:1:table1} on page \pageref{tab:1:table1} refers to the ...
%\item [table2] Table \ref{tab:2:table2} on page \pageref{tab:2:table2} refers to the ...
%\item [table3] Table \ref{tab:3:table3} on page \pageref{tab:3:table3} refers to the ...
%\item [table4] Table \ref{tab:4:table4} on page \pageref{tab:4:table4} refers to the ...
%\item [table5] Table \ref{tab:5:table5} on page \pageref{tab:5:table5} refers to the ...
%\item [table6] Table \ref{tab:6:table6} on page \pageref{tab:6:table6} refers to the ...
%\end{itemize}
...
% \label{tab1:table1}
  \hskip-2.5cm\begin{tabular}{llll}
    \toprule
    \multicolumn{4}{c}{Adimensional primary constants}                   \\
    \cmidrule(r){1-4}

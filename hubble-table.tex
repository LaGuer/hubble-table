...
\node [anchor = east] at (0.,-0.6) {$\phi^{4}$};
\draw [<->] (-3.2,-0.15) node[left]{} -- (0,-0.15) node[right]{};
\draw [<->] (0.,-0.15) node[left]{} -- (3.42,-0.15) node[right]{};
\draw [<->] (-3.2,-0.35) node[left]{} -- (3.42,-0.35) node[right]{};
  %\draw [decoration={markings,mark=at position 1 with
   % {\arrow[scale=3,>=stealth reversed]{<}}},postaction={decorate}] (-3.2,-0.3) -- (3.42,-0.3);
\node [anchor = east] at (2.,-0.20) {$\omega$};
\node [anchor = east] at (-1.,-0.20) {$z$};
\clip(-6.,-0.4) rectangle (0.4,3.4);
...
%\tkzLabelAngle[pos=0.6](A,q,B){$\sqrt{\omega z}$}
  ...
  \draw [very thin,black,line join=round] (0,0,0)  -- node [sloped,above,text width=2mm] {$4\sqrt{(3H\beta/n)}$} (4.9,1.,4.6);

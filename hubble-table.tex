...
The product taking account of only the main bosons and their anti-particles, shows up the three coupling constants (gravitationnal, electric and strong nuclear):

\begin{equation}
\Pi_{12} = n \cdot p_+ \cdot p_-  \cdot   \Pi_0 \cdot  \Pi_+  \cdot  \Pi_- \cdot  K_0  \cdot K_- \cdot Z \cdot  W_+  \cdot  W_-  \approx P/aa_s
\end{equation}




The number 495 doubly connects with this series in the search for solutions involving 3 terms, among the 11, with powers limited to 2 and precision $5 \times 10^{-4} \approx (a/137)^2$:

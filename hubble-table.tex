...
implying the above canonical factor $a/20$. The analysis leads to:
 ...
 \begin{equation}
a^2/137 \approx 20 ~ (\Phi p_W/p)^4   ~~~~~ \rightarrow p_W = 6\pi^5  ~~ \pi : 3,7,16,a_s^2\tau/\mu  
\end{equation}  
 
implying the Lenz-Wyler formula $p\W$ for the proton/electron mass ratio, as recalled below.
...
\textit{It seems that the parameters are distributed in an optimal manner, calling for further study. But it is now clear what is the signifiance of the product of terms in a series. Indeed, looking for an insertion in the series of an additive term, this implies the consideration of this product, which is the maximum to be considered, and its geometrical mean, which is the most probable term to try.}

...
Thus it is looked if the 26 sporadic groups shows the presence of 136 terms. Indeed, the sum of the terms of basis inferior or equal to 17, the nearest number to g(1), is 137, which decomposes among the 4 distinct families according to:

\begin{equation}
23 (Matthieu family) + 36 (family 2) + 49 (family 2) + 29 (Pariah family) = 23 + 114 = 137 
\end{equation}
...
\begin{equation}
Pi_{Mat} \ approx 20^{23} \approx (6/\pi) 495^{11} \approx (e^a \sqrt 2 /3)^{1/2} \approx 
\end{equation}

where $\Pi_{11}$ is the product of the 11 main mass ratioes relative to electron in particle physics (table 1): Nambu ($a$), proton, neutron, muon, tau, Ions, Kaons, bosons intermédiaires.  

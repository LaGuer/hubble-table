...
\centering
\includegraphics[width=\textwidth,height=14cm]{./figure/weinberg-triaxis}
\caption[Weinberg tri-Axis]
{The Weinberg Tri Axis figure.}
\end{figure}

\begin{figure}
\centering
\begin{tikzpicture}
  \draw (6.4,0,0) coordinate (x) |- (0,1,0) coordinate [midway] (h) coordinate (y) -- (0,1,3.4) coordinate (a) -- (0,0,3.4) coordinate (z) -- (6.4,0,3.4) edge (x) -- (6.4,1,3.4) coordinate (v) edge (h)
  -- (a)  ;
...
\end{tikzpicture}
\caption{Weinberg cuboid properties.}
\end{figure}

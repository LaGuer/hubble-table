...
$e^2\approx (3/2)^5 $ one gets $3^7/2^11 \aaprox 1$, which is the classical apotome interval. Moreover $3^11 - 2^7 = 139 = 2^0 + 2^1 +2^3 + 2^7$, which is the sum corresponding to the four division algebra, corresponding to the dimensions 1,2,4,8, with the reduced numbers 0,1,3,7. Atiyah noted only the reduced sum : $2^0 + 2^1 +2^3 + 2^7$ = 137$. 

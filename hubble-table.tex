...
\centering
\begin{tikzpicture}
  \draw (6.4,0,0) coordinate (x) |- (0,3.4,0) coordinate [midway] (h) coordinate (y) -- (0,3.4,1) coordinate (a) -- (0,0,1) coordinate (z) -- (6.4,0,1) edge (x) -- (6.4,3.4,1) coordinate (v) edge (h)
  -- (a)  ;

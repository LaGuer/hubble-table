...
precise to 6 ppm. This connects again with the Topological function : $f(6) \approx \tau/9\mu$. 

With $u_a = \sqrt a /8d_e^2 + 2$, one notes:

\begin{equation}
u_a (4-u_a)^2 \approx (2\3^3 )^{1/\pi a}
 \end{equation}

precise to 30 ppb, showing that \textit{the cosmos uses the approximation $e^4\approx 2\time 3^3$}

$e^4 \approx 54$, one notes that

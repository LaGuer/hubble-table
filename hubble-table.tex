...
\section{The scope and method}
   ...
   \section{The computational signifiance of $a$}
         ...
         Our main hypothesis is that \texit{the Cosmos is a computer using these parameters as optimal calculation basis}, in particular the electric constant $a$ and the proton-electron mass ratio $p$.
...
\begin{equation}
\sqrt {a i^{1/i}} \approx a + 1 + 1/ 2\pia
\end{equation}

givng $a$ to 3 ppb. Quite independently, Hans de Vries \cite{deVries} gave a formula expliciting the other terms in the development.
...
\begin{equation}
x \approx 136 \times 137 \sqrt{2p_G} 
\end{equation}

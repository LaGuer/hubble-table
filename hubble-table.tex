...
\author{F. M. Sanchez \thanks{Retired Prof of Physics, University of Paris 11, Orsay, France} email \href{mailto:hol137@yahoo.fr}{hol137@yahoo.fr}
   %%\\ email \href{mailto:hol137@yahoo.fr}{hol137@yahoo.fr}  	  
   \and M. H. Grosmann \thanks{Retired Prof of Physics, University of Strasbourg, France} email \href{mailto:michelgrosmann@me.com}{michelgrosmann@me.com}
   %%\\ email \href{mailto:michelgrosmann@me.com}{michelgrosmann@me.com} 
   \and R. Veysseyre \thanks{Retired Prof of Mathematics, Agr\egee de mathematiques et professeur honoraire \`a l’Ecole centrale de Paris, France} email \href{mailto:renee.veysseyre@normalsup.org}{renee.veysseyre@normalsup.org}
   %%\\ email \href{mailto:renee.veysseyre@normalsup.org}{renee.veysseyre@normalsup.org} 
   \and D. Weigel  \thanks{Retired Prof of Cristallography, University of Paris 6, Paris, France} email \href{mailto:dominiqueweigel118@gmail.com}{dominiqueweigel118@gmail.com} 
   %%\\ email \href{mailto:dominiqueweigel118@gmail.com}{dominiqueweigel118@gmail.com} 
   \and L. Gueroult \thanks{Retired PhD instructor in Holography at ENS, Physics department A2, Cachan, France} email \href{mailto:lgueroult@hotmail.com}{lgueroult@hotmail.com}
...
\begin{abstract}
The Computational Hypothesis implies the quantization of the Archimedes constant. This validates the Wyler's theory and the Fermion Koide formula in the $10^{-9}$ domain. Also the Eddington's equation is fully rehabilitated, by connecting the four forces. The Permanent Oscillatory Cosmology is confirmed by 202 formulas giving the invariant Hubble radius, with 14 correlating to $10^{-9}$, whose two are obtained by the computer using the Atiyah constant and the Eddington's electric constant, the whole number $137 \approx a $. This complies with the Physics-Arithmetics unification predicted by Atiyah.   
\end{abstract}
...
\begin{table}
\caption{41 formulas for the Hubble radius, with better precision than 0.1 \%}
\label{tab:5:table5}
  \hskip-2.0cm\begin{tabular}{llll}
    \toprule
    %\multicolumn{4}{c}{}                   \\
...
\label{tab:6:table6}
  \hskip-2.0cm\begin{tabular}{llll}
   ...
   \#     & Formula     & Value~~(Glyr) & Remarks \\
    ...
    42 & $(p_W/p) \lambdabar_{n} S^{4/\sqrt a}   $ & 13.81197 & confirms the central role of the diametral entropy  $ S = \pi (R/l_P)^2$ \\      
...
\begin{table}
\caption{14 ppb precise formula for $R \approx 13.8119768$ Gly}
\label{tab:6:table6}
  \hskip-2.0cm\begin{tabular}{llll}
    \toprule
    \multicolumn{3}{c}{}                   \\
...
\centering
     ...
     coordinates {
       ...
       (13.81177,0.018) +- (0.0001,0.0045)
       (13.81190,-0.018) +- (0.0001,-0.0045)

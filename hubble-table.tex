...
See Table section \ref{tab:table1} 40 formulas for the Hubble radius with 1\% precision.
See Table section \ref{tab:table2} 22 formulas for Hubble radius with $2.10^{-4}$ precision.
See Table section \ref{tab:table3} 7 ppb precise formulas for $R \approx 13.8119768$ Gly.
See Table section \ref{tab:table4} physical constants.
See Table section \ref{tab:table5} cosmic constants.

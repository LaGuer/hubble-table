...
\label{tab:6:table6}
  ...
  7 & $2N_{Ed}(l_P^2/\lambdabar_n) (r_H/\lambdabar_e)^3/ \pi 496^2 $ & 13.81207 & confirms the superstring 496\\
   ...
   49 & $ (c/C) \Phi^{a/4\pi^2} (3n/2p)^2 sqrt(a/137)  $ & 13.81183 & confirms the Golden Ratio $\Phi$ \\ 
    ...
    52 & $ 2l_P e^a (2r_H \beta^2 \ d_e^2 lambda_e)^{2/3}   $ & 13.81198 & confirms the role of $e^a$  \\
...
\label{tab:6:table6}
  \hskip-2.0cm\begin{tabular}{llll}
    ...
    17 & $ 8\pi l_P (R_N/\lambda_{CW})^2 (137/\pi_0)^{1/3}   $ & with $\pi0 = 3+1/(7+1/(16+1/12^2)),~~~~(137/\pi_0)^2\approx (137/\pi)^2 +1/4 + 2/127 $   \\

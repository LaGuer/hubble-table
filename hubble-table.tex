...
The \textit {effective} mixing angle 0.21355(4) \cite{Tanabashi} is compatible with $ln^2\Phi \approx 0.2315648$. The formulas # 15 and #16 of Table \ref{tab:5:table5} tying $R$ to $\Phi$ and $ln\Phi$ implies the following ppm correlation: 
...
$j_0$ enters the simplest couples of all formulas (#15 and #16 in 

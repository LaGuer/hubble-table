...
\section{The Rehabilitation of Wylerâ€™s theory}
The presence of an excess $\pi$ in the above formula suggests that $\pi$ is also a computation base for the cosmos.This is indeed the case in the even Rieman series.
...
Indeed, the above canonical number $a^a$  is also very close to the Lucas-Lehmer term $S_9 = g_3^{2^9$}, where $ g_3 = 2 + \sqrt3$ is the generator of quasi-whole numbers. Now, the Lucas-Mersenne Large Number $2^{127} - 1$ plays a central roe in Coherent Cosmology \cite{Sanchez}. It is prime because it is a divisor of the number $S_125$, which appears to connect also in cosmology (first formula of table 2).

Now, $a^a$ connects also directly with the famous Ramanujan quasi-whole number $N_R = exp(\pi \sart{163})$, tied to the above Heegner-Stark number 163, which shows dramatic correlations:
...
\section{The connection with the Periodic Table of Elements}
    ...
    Writing $k_{12+}$ in function of $k_{12-} = k_{10+}$, one has$ k_{12+} = 2,  k_{12-} + k_{10-} - 2$. Now   $k_{10-} = k_{10+} - 254$, so showing the singularityÂ : $3k_{12-} - k_{12+}  = 16 Ã— 16$. This comes back to the Eddington matrix and the central topological dimension 16 (Fig. 1). So it seems that the dimension 12 will play a role in the future string theory.
...
\begin{table*}
  \hskip-2.0cm\begin{tabular}{llll}
    \toprule
    \multicolumn{4}{c}{Table 1.40 formula for the Hubble radius, with better precision than 1 \%}                   \\
    \cmidrule(r){1-4}
   \#     & Formula     & Value~~(Gyr) & Remarks \\
    ...
    4 & $\lambdabar_e g(6)$ & 13.82 & with the topological function $g(k)=exp(2^{k+1/2})/k$ for k=6 (d=26, critical dimension)\\
    
    
5 & $\lambdabar_e (|tau/\mu)^{32}/w& 13.83 & 6g(6) = g(1)^{32}\\     
    
    6 & $(2\lambdabar_{e}/3)(\lambdabar_{CMB}/\lambdabar_{H2})^3$ & 13.90 & 3D holographic term in $2\pi R/\lambdabar_e \approx 4\pi (\lambdabar_p/l_P)^2 \approx (4\pi /3) (\lambdabar_{CMB}/\lambdabar_{H2})^3$ \\
    7 & $\lambdabar_e S_4^5$ & 13.80 & hoographic 5D extension\\
    
    8 & \lambdabar_e \Gamma^{55/2}& 13.80 & implies s_4 \approx \Gamma^{11/2}\\
    
     9 & \lambdabar_e exp(j\sqrt (137/a) - \Gamma) & 13.82 &confirms the Atiyah and Sternheimer constants\\ 
     
      10 & \lambdabar_e exp((p^2-p_{W,a,137}^2 - j/\pi) &13.81& with p_{W,a,137} = 6(a^2 - 137^2)^{5/2} \approx 1833.99827~~ confirms Wyler's theory\\ 
  ...
  23 & (2\pi^{32}P\labdabar_e)^2 /R_N & 13.80 & ties to l_{WCMB}/l_P \approx \pi^{64}\\        
   ...
   26 & \lambdabar_F P^3 /p^7 & 13.80 & P and p computation bases\\      
     
     
27 & \lambdabar_F P^2 e/8$ & 13.81 &  related to \sqrt a  \approx 32/e \\     
     
   
    28 &  $\lambda_e O_M^{7/10}$ & 13.94 &  related to $O_M^{7/10} \approx 496$, dimension of the superstring SO32 gauge group  \\
...
\begin{table*}
  ...
  2 &\lambdabar_e ((a-136)E_3^{\sqrt a})^{1/2}& 13.814 & E_3 = e^{e^e} \approx E_4^{1/ap} \approx e^{3e+7}\approx \tau \times 8a ; a\approx e^7/8 \\
   ...
   13 & 3^{1/137} R_{GC}^{2/3} r_e^{4/3} /l_K & 13.8124 & confirms the liaison Grandcosmos-quasar period\\
    ...
    17 &2\beta $\lambdabar_e j^{17} (4\pi)^2 \sqrt{137}$ & 13.81198 & j calculation basis \\
   
    18 &  $\lambda_e (3j^j/2H)^{1/6}$ & 13.81199 & j and a : related computation bases : (j^j)^{5/4} \pprox a^a\\
    ...
    21 & $4l_Kp^4 \sqrt{p/H}/\beta d_e & 13.81198 & confirms the non-Doppler quasar period \\
     ...
     22 & 2(l_K/F)^2/\lambdabar_e & 13.81198(3) &from elimination of $c$ between gravitational and electroweak couplings \\
...
[1] \bibitem {Hirzebruch} Hirzebruch F. Topological methods in algebraic geometry. Springer 1966.\\

[2] \bibitem {Bott} M. Atiyah, R. Bott, V. Patodi, "On the heat equation and the index theorem" Invent. Math. , 19 (1973) pp. 279â€“330.\\

[3] \bibitem {Singer} M. Atiyah, I. Singer, "The index of elliptic operators IV" Ann. of Math. , 93 (1971) pp. 119â€“138. \\

[4] \bibitem {Alvarez} L. Alvarez-GaumÃ©, "Supersymmetry and the Atiyahâ€“Singer index theorem" Comm. Math. Phys. , 90 (1983) pp. 161â€“17.\\

[5]\bibitem{Atiyah} Atiyah M. https://hitsmediaweb.h-its.org/Mediasite/Play/35600dda1dec419cb4e99f706197a3951d. \\ 


[6]\bibitem {Sanchez} F.M. Sanchez, V. Kotov, M. Grosmann, D. Weigel, R. Veysseyre, C. Bizouard, N. Flawisky, D. Gayral, L. Gueroult, Back to Cosmos.\\

[7] \bibitem{Atiyah1} Atiyah M. Private Communication (december 2018).\\

[8]\bibitem{Tanabashi} Tanabashi M. et al. (Particle Data Group), Phys. Rev. D98, 030001 (2018), and 2019 update.\\

[9] \bibitem {Wyler} Wyler A., "L'espace symetrique du groupe des equations de Maxwell" C. R. Acad. Sc. Paris, t. 269, 743-745 (1969). Wyler A., C.R. Acad. Sci, Paris "Les groupes des potentiels de Coulomb et de Yukawa". C. R. Acad. Sc. Paris, t. 272, 186-188 (1971).\\

[10]  \bibitem {Apostol} Apostol T. Modular functions and Dirichlet Series in Number Theory. Springler-Verlag. New-York (1990).\\

 [11] \bibitem {Lovelace} Lovelace C. (1971) Pomeron form factors and dual Regee cuts, Physics Letters B34 (6) 500-506.\\

[12] \bibitem {Conway} Conway, John Horton; Norton, Simon P. (1979). "Monstrous Moonshine". Bull. London Math. Soc. 11 (3): 308â€“339.\\

[13] \bibitem {Borcherds} Borcherds, Richard (1992), "Monstrous Moonshine and Monstrous Lie Superalgebras", Invent. Math., 109: 405â€“444.\\ 

[14] \bibitem {Green} Green, M. Schwarz J. (1984)  Anomaly cancellations in supersymmetric D = 10 gauge theory and superstring theory". Physics Letters B. 149: 117.\\



 [15]\bibitem {shray} Shray J. (1994) Octonions and Supersymmetry, PhD thesis.  http://ir.library.oregonstate.edu/xmlui/handle/1957/35649. \\

[16] \bibitem {Koide} Koide Y., Fermion-Boson Two-Body Model of Quarks and Leptons and Cabibbo MixingÂ  Lett. Nuovo Cimento 34, 201 (1982). v 

[17] \bibitem{Eddington} Eddington A, Fundamental Theory, Cambridge.\\

[18]\bibitem{Bastin} Bastin T. and Kilmister C.W., Combinatorial Physics (World Scientific, 1995).\\

[19] \bibitem{Sanchez1}  Sanchez F.M., Holic Principle, Entelechies, ANPA 16, Sept. 1995. Bowden K.G., 324-43.\\

[20]  \bibitem {Hooft} Hooft 't Th Holographic Principle. AeXiv: hep-th/003004 (2000). \\

[21]\bibitem {Bousso} Bousso R., â€œThe Holographic Principleâ€, Review of Modern Physics, vol 74, p.834 (2002).\\

[22]\bibitem {Friedman} Friedman W. et al, The Carnegie-Chicago Hubble Program. VIII. An Independent Determination of the Hubble Constant Based on the Tip of the Red Giant Branch, arxivÂ : 1907.05922.\\ 

[23] \bibitem{Sanchez2} Sanchez F.M., Kotov V. and Bizouard C., 'Towards a synthesis of two cosmologies: the steady- state flickering Universe'. Journal of Cosmology, vol 17. (2011).\\

[24]\bibitem{Quinn} Quinn T, Speake C, Parks H, Davis R. 2014 The BIPM measurements of the Newtonian constant of gravitation, G. Phil.Trans. R. Soc. A372: 20140032. http://dx.doi.org/10.1098/rsta.2014.0032. \\

[25] \bibitem{Sternheimer} Sternheimer J., Musique des particules Ã©lÃ©mentaires, CRAS, 297, II, 829-834 (1983).\\

[26]\bibitem{Weigel} Veysseyre R., Veysseyre H., and Weigel D. Counting, and Symbols of Cristallographic Point Symmetry Operations of Space En. AAECC 5, 53-70 (1994).\\

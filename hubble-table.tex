...
% \author{F. M. Sanchez\footnote{Universit\'{e} Paris 11, Orsay, France}, M. H. Grosmann\footnote{Universit\'{e} Louis Pasteur, Strasbourg, France}, R. Veysseyre \footnote{Ecole Centrale, Paris, France}, D. Weigel \footnote{Universit\'{e} Paris 6, Paris, France}, L. Gueroult \footnote{ENS, Cachan, France}}

%% Group authors per affiliation:
%\author{Francis M. Sanchez\fnref{myfootnote}}
%\author{Francis M. Sanchez}

%\author{F. M. Sanchez (Universit\'{e} Paris 11, Orsay, France)}
%\author{M. H. Grosmann (Universit\'{e} Louis Pasteur, Strasbourg, France)}
%\author{R. Veysseyre (Ecole Centrale, Paris, France)}
%\author{D. Weigel (Universit\'{e} Paris 6, Paris, France)}
%\author{L. Gueroult (ENS, Cachan, France)}
%\author[mymainaddress,mysecondaryaddress]{F. M. Sanchez, M. H. Grosmann, R. Veysseyre, D. Weigel, L. Gueroult}
...
% \ead{----at-hotmail.com}
% \address[mymainaddress]{ENS, 94 Cachan}
% \cortext[mycorrespondingauthor]{Retired Professor}
% \cortext[mycorrespondingauthor1]{Agregee de mathematiques and prof honoraire at l'Ecole centrale de Paris}
% \cortext[mycorrespondingauthor2]{Retired Holography instructor}
...
\begin{document}
   ...
   %\author{F. M. Sanchez\inst{\ref{inst1}}\and  M. H. Grosmann\inst{\ref{inst2}}\and R. Veysseyre\inst{\ref{inst3}}\and D. Weigel\inst{\ref{inst4}}}
   \author{F. M. Sanchez\footnote{Universit\'{e} Paris 11, Orsay, France}, M. H. Grosmann\footnote{Universit\'{e} Louis Pasteur, Strasbourg, France}, R. Veysseyre \footnote{Ecole Centrale, Paris, France}, D. Weigel \footnote{Universit\'{e} Paris 6, Paris, France}, L. Gueroult \footnote{ENS, Cachan, France}}

% \institute{Retired Prof. Universit\'{e} Paris 11, Orsay, France\email{hol137-at-yahoo.fr}\label{inst1}\and Retired Prof. Universit\'{e} Louis Pasteur, Strasbourg, France\email{michelgrosmann@me.com}\label{inst2}\and Retired Prof. Ecole Centrale, Paris, France\email{renee.veysseyre@gmail.com}\label{inst3}}


%\author[1]{F. M. Sanchez}
%\author[2]{M. Grosmann}
%\author[3]{R. Veysseyre}
%\author[4]{D. Weigel}
%\author[5]{L. Gueroult}
...
%\author{F. M. Sanchez\footnote{Universit\'{e} Paris 11, Orsay, France}, M. H. Grosmann\footnote{Universit\'{e} Louis Pasteur, Strasbourg, France}}
%\address{Universit\'{e} Paris 11, Orsay, France\,\footnote{Retired}\\
%\email{author\_id@domain\_name\footnote{hol137-at-yahoo.fr}}
%\http{$<$webaddress$>$}}

%\author{M. H. Grosmann}
%\address{Universit\'{e} Louis Pasteur, Strasbourg, France\,\footnote{Retired} author\_id@domain\_name}

\maketitle

\begin{abstract}
The Permanent Oscillatory Cosmology is confirmed by 90 formula giving the Hubble radius, with 7 correlating to $10^{-9}$. The computer obtained the best formula using the Atiyah constant and the number 137, the Eddington's electric constant. This conforms with Atiyah's testimony about the Physics-Mathematics unification and the central role of arithmetics in this unification process. The identification with the Eddington statistical formula gives $G$, compatible with the $10^{-5}$ precise BIPM measurement and the $10^{-6}$ precise sun-quasar non-Doppler Kotov period. The hypothesis of a computing Cosmos implies a $\pi$ rationalization process which validates the Wyler's theory and the Fermion Koide formula in the $10^{-9}$ domain. Also the Eddington's equation is fully rehabilitated, by connecting the four forces.  
...
\label{tab:4:table4}
  \hskip-2.0cm\begin{tabular}{llll}
    \toprule
    \multicolumn{4}{c}{Table 4. 44 formulas for the Hubble radius, with better precision than 1 \%}                   \\
    \cmidrule(r){1-4}
...
\label{tab:5:table5}
  \hskip-2.0cm\begin{tabular}{llll}
    \toprule
    \multicolumn{4}{c}{Table 5. 39 formulas for Hubble radius, with better precision than $2 \times 10^{-4}$}                   \\
    \cmidrule(r){1-4}
...
For the intermediary superstring value $d = 10$, there is the mean \textit{Pion}. For d $\approx \gamma \times \Gamma$, Y $\approx 495^2$ the square of the diminished Green-Schwarz string dimension (496 - 1), it is the \textit{Brout-Englert-Higgs boson} (125.175 GeV). For k $\approx 2e^e$, it is the \textit{topon}, the visible Universe wavelength, the space quantum, which identifies with the mono-radial unit length of the Bekenstein-Hawking Universe entropy (section ).
   \textit{With unit $2\pi$ times the Nambu mass $m_N~=~am_e$}, $d = 24 and 2$6 corresponds to the \textit{photon and graviton masses}, defined by the two-step holographic interaction\cite{Sanchez}. The central dimension is $d = 16$, for a total of $2^7$ string dimensions in the Bott sequence. This suggests a liaison with the Eddigton's matrix $16 \times 16$ \cite{Eddington}. 

...
45,x=1.0cm,y=1.0cm]
%\label{tab:15:table15}
\tkzDefPoint(-0.236,0.0){A} \tkzDefPoint(0.0,0.944){B} \tkzDefPoint(3.764,0.){C} \tkzDefPoint(0.0,0.0){D}
\tkzDrawPoints(A,B,C,D)
\tkzMarkRightAngle(A,B,C)
\tkzMarkRightAngle(B,D,C)
\tkzLabelPoints[below](A,C,D)
...
\draw[color=green] (-1.056,0.) -- (0.,-1.764);
\draw[color=green] (-1.764,0.) -- (0.,0.0);
\draw[color=green] (-1.056,0.) -- (2.944,0.);
\draw[color=green] (0.,-1.764) -- (2.944,0.);
\draw[color=blue] (0.,0.) -- (0.,-1.764);
% 1st triangle
...
%\tkzMarkRightAngle[fill=blue!20](B,F,C)
\end{tikzpicture}
\caption[The holographic Triangle properties.]{Holographic triangle is caracterized by $S=h=\sin\theta$; the height h and the area S are both eual to $\sin\theta$.}
\end{figure}

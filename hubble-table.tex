...
\node [anchor = east] at (2.,2.5) {$\approx 5$};
\node [anchor = east] at (-1.,2.5) {$\approx \sqrt{22}$};
\node [anchor = north] at (0.,-1.0) {$\approx \phi^{4}$};
\draw [<->] (-3.2,-0.1) node[left]{} -- (0,-0.1) node[right]{};
\draw [<->] (0.,-0.1) node[left]{} -- (3.42,-0.1) node[right]{};
\draw [<->] (-3.2,-0.6) node[left]{} -- (3.42,-0.6) node[right]{};

...
Table \ref{tab1:table1} on page \pageref{tab1:table1} refers to the ...
Table \ref{tab2:table2} on page \pageref{tab2:table2} refers to the ...
Table \ref{tab3:table3} on page \pageref{tab3:table3} refers to the ...
Table \ref{tab4:table4} on page \pageref{tab4:table4} refers to the ...
Table \ref{tab5:table5} on page \pageref{tab5:table5} refers to the ...
Table \ref{tab6:table6} on page \pageref{tab6:table6} refers to the ...
%\subsection{Tables}
%\begin{itemize}

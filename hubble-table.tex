  ...
  \hskip-2.5cm\begin{tabular}{llll}
   ...
   de Vries Electric constant  & $a_{deV} $   & 137.03599909582970048 & 'exact' \\
    ...
    Modular number & $j_0$    & 744  & exact \\ 
     ...
     Happy Family order product $\approx exp(674.5210288) $   & $\Pi_{hap}$   &$2^{301}\cdot 3^{142} \cdot 5^{57} \cdot 7^{30} \cdot 11^{18} \cdot 13^{10} \cdot 17^5 \cdot 19^4 \cdot 23^9 \cdot 31^3 \cdot 47^2\cdot 59 \cdot 71 $  & exact \\        

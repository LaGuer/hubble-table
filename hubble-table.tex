...
\begin{itemize}
\textbullet Table \ref{tab:1:table1} on page \pageref{tab:1:table1} refers to the ...
\textbulletTable \ref{tab:2:table2} on page \pageref{tab2:table2} refers to the ...
\textbulletTable \ref{tab:3:table3} on page \pageref{tab3:table3} refers to the ...
\textbulletTable \ref{tab:4:table4} on page \pageref{tab4:table4} refers to the ...
\textbulletTable \ref{tab:5:table5} on page \pageref{tab5:table5} refers to the ...
\textbulletTable \ref{tab:6:table5} on page \pageref{tab6:table6} refers to the ...
\end{itemize}
%\subsection{Tables}
%\begin{itemize}

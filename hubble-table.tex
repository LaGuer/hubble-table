...
\textit{As predicted \textcolor{red}{cite{ref missing for [8]}}, it is now proven that the physical constants are tied to rational approximations of $\pi$: this could be ultimate signification of the renormalization..}
...
\section{The connections between the main Particle parameters, the Mathieu family and the Topological Axis }

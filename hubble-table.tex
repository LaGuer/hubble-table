...
In particular the optimal basis $e$ cheks:
...
\textit{This explains the central role of 495, so the presentation of the Higgs boson to be responsable of the particle mass spectrum seems verified.}
...
The ratio $p_E$  is close to $(16/10)^16$, due to the $16 \times 16$ starting matrix. Now, the study of musical inervals shows that its square root $(16/10)^8 \approx (3/2) \Phi^7$. Now $\sqrt {p_E} \approx 17 \times 19 / 200$, to 11 ppm, showing a rationalisation of the golden ratio which enters the Pariah group $J_3$:

...
\begin{equation}
X \approx \Gamma ^{1/sin^(\theta_{eff})} \approx (1/\gamma)^{\Gamma (1+1/a_0)}
\end{equation}  


Thus the Eddington number 137 is fully rehabilitated and the constant $a$ is connected with main matematical constants.

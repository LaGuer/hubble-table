...
Moreover, as $x_1 \approx 2^{2^9/136}$, it connects with the critical radius $R$, implying a liaison with gravitation \cite{Sanchez}. \textit{So the 4 forces are implied in the Eddington's equation}.

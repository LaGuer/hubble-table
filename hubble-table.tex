...
\item [table2] Table \ref{tab:2:table2} on page \pageref{tab2:table2} refers to the ...
\item [table3] Table \ref{tab:3:table3} on page \pageref{tab3:table3} refers to the ...
\item [table4] Table \ref{tab:4:table4} on page \pageref{tab4:table4} refers to the ...
\item [table5] Table \ref{tab:5:table5} on page \pageref{tab5:table5} refers to the ...
\item [table6] Table \ref{tab:6:table5} on page \pageref{tab6:table6} refers to the ...
\end{itemize}
%\subsection{Tables}
%\begin{itemize}

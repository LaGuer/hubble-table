...
A research on computer looking for an holographic relation, of type $3X^2 = Y^3$, between the terms $a, p_W, p and H$ leads to the 61 ppm relation, involving the canonic dimensions 16 and 24, and connecting with the monster group order to 100 ppm:

\begin{equation}
3 (p_W H/p)^{16} \approx (H^2/p_W \sqrt a )^{24} \approx O_M / 16
\end{equation}

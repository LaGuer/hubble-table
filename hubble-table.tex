...
'Atiyah constant' Γ = γa/π. Meanwhile, he rehabilitated the Eddington bare electrical constant, the
...
article how this Atiyah constant Γ ties R and G, to 10^-9 precision, by using the number 137 and the
electroweak Fermi constant. Moreover, Γ enters the Topological Axis (Fig. 1), both in connexion
...
the superstring 9D space with canonic constants ω (reduced Wien displacement constant) and
...
of a d-distant galaxy $v = c ∆λ/λ$. So, there is the direct simpler relation $∆λ/λ = d/R$. Moreover, this
...
%\lipsum[5]
The so-called standard Universe age is 13.80(2) ×10 9 years, while the Hubble radius deduced

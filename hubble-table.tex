...
\newwatermark[allpages,color=red!20,angle=45,scale=1,xpos=0,ypos=0]{Peer review required}
%\pagenumbering{gobble}

%\title{The Hubble Table and the \emph{big-Boom-bang effect}}
\subtitle{Atiyah's Physics-Mathematics Unification confirms the Permanent Cosmology}

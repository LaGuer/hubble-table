...
corresponding to $ sin^2(\theta_{eff})\approx 0.231490 \approx sqrt{(a_0 -3)/d_e}/2\Gamma$, compatible with the measurement \cite{Tanabashi}. The pertinence of the Atiyah constant is fully confirmed.

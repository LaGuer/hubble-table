...
\label{tab:8:table8}
  ...
  19 & 2 $\lambdabar_{e} (a/137) (p/6) (pH)^6\pi_{synth}^5= /a_s (1+a^2/F) $ & from the Eddington's equation, involving the 4 coupling forces, with $\pi_{synth} = 3+1/(7 + 1/(16 -(a-137) +2/a_s\pi_4$  \\ 

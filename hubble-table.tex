...
\section{The connection with the Periodic Table of Elements}
 ...
 \section{connection with the high-dimensional crystallography}
    ...
    \begin{equation}
    $K_{10+} +K_11+}+(K_{12+} = K_{11-} +K_{12-}+(K_{13-}$ = 1839   
    \end{equation}
    ...
    Note that the roots of the crystallographic algebraic equation of degree $n$ are of type $exp(i2\pi m/l)$, where $l$ and $m$ are whole numbers such that $l \le n$ and $1 \le m \le l$,  : this is similar to the above spectroscopic series. Such an unexpected connection needs also further study.   
...
\begin{itemize}
\item [A1] See Table section \ref{tab:table1} 40 formulas for the Hubble radius with 1\% precision.
\item [A2] See Table section \ref{tab:table2} 22 formulas for Hubble radius with $2.10^{-4}$ precision.

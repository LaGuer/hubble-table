...
Note that this seems to imply that the CMB is a coherent signal, at complete variance with the believing of no-informative thermal processes. Also, the vaccum energy in the proton volume is close to the Universe one, as noted by Haramein \cite{Haramein}. This is a new Large Nulmber correlation which adds a new liaison in the Topological Axis: between the dimensions 22 and 30. 
...
\bibitem{Freeman} Freeman J. `` '', Phys. Rev. D 7:2333-2346 Issue:8. DOI:10.1103/PhysRevD.7.2333 (1973)

...
\label{tab:6:table6}
  \hskip-2.0cm\begin{tabular}{llll}
   ...
   \#     & Formula     & Value~~(Glyr) & Remarks \\
    ...
    42 & $(p_W/p) \lambdabar_{n} S^{4/\sqrt a}   $ & 13.81197 & confirms the central role of the diametral entropy  $ S = \pi (R/l_P)^2$ \\ 43 & $  (n/p)^{1/3} R_C Ppu_{cr}/O_M O_B H u_{CMB}   $ & 13.81197 & overall confirmation  \\
    
    
     43 & $  (2^{11^2} a p P^2/n^2)^{1/3} R_C/O_M O_B   $ & 13.81197 & confirmation of laison Cosmos-Monter groups  \\
    
    
    43 & $  (n/p)^{1/3} R_C Ppu_{cr}/O_M O_B H u_{CMB}   $ & 13.81197 & overall confirmation  \\

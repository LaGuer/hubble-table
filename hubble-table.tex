...
Writing $\sqrt{j_0}$ as a dimension $2+4k$, this shows that $k \approx 2 \pi_{Egy}$, where \pi_{Egy} = (4/3)^4. This leads to the 14 ppb relation: 

\begin{equation}
 sqrt{j_0} \approx 2 (1+4pi_{Egy}) - 1/137 -1/\tau
\end{equation}

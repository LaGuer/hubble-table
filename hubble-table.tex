...
\usetikzlibrary{calc,angles,positioning,intersections,through,quotes,decorations.markings}
...
\begin{tikzpicture}
\label{tab:10:table10}
%\caption{The Electric Triangle properties.}
%\RectTri{(0,3)}{(1,0)}{6cm}
%\begin{scope}[xshift=7.5cm]
%\RectTri[black]{(0,0)}{(4,2)}{4cm}
%\end{scope}
%\begin{scope}[xshift=12.5cm]
\RectTri[blue]{(0,2)}{(3,2)}{4cm}
%\end{scope}
\end{tikzpicture}
\caption{The Electric Triangle properties.}
\end{figure}
...
%\caption[The Weinberg Triangle]{The Weinberg Triangle properties.}
\RectTri{(0,3)}{(1,0)}{6cm}
%\begin{scope}[xshift=8.5cm]
%\RectTri[black]{(0,0)}{(4,2)}{4cm}
%\end{scope}
\end{tikzpicture}
\caption{The Weinberg Triangle properties.}
\end{figure}
...
%\end{scope}
%\end{tikzpicture}
%\caption{The Sanchez Triangle properties.}
%\end{figure}

\begin{figure}
\centering
\begin{tikzpicture}
\label{tab:12:table12}
\tkzDefPoint(0:0){C}
\tkzDefPoint(0:3){B}
\tkzDefPoint(18:3){A}
...
\tkzDrawSegment[blue!60!black](A,C)
\tkzDrawSegment[blue!60!black](C,B)
\tkzDrawSegment[blue!60!black](A,B)

\tkzDrawAltitude[dashed,color=magenta](C,B)(A)   %% draw the perpendicular
\tkzGetPoint{P}                                  %% get the point P
\tkzLabelPoint[below](P){$\sqrt{a}$}             %% label the point P
%\tkzDrawSegment[dashed,color=magenta](C,P)      %% draw CP
\tkzMarkRightAngle(C,B,A)

\tkzLabelSegment[auto,swap](B,A){$\sqrt{a'}$}
\tkzLabelSegment[auto](B,C){$ $}
\tkzLabelSegment[auto](C,A){$\sqrt{a''}$}
...
\tkzDrawSegment[red!60!black](A,C)
\tkzDrawSegment[red!60!black](C,B)
\tkzDrawSegment[red!60!black](A,B)

\tkzDrawAltitude[dashed,color=magenta](C,A)(B)   %% draw the perpendicular
\tkzGetPoint{P}                                  %% get the point P
\tkzLabelPoint[below](P){$\textit{q}$}             %% label the point P
%\tkzDrawSegment[dashed,color=magenta](C,P)      %% draw CP
\tkzMarkRightAngle(C,B,A)

\tkzLabelSegment[auto,swap](B,A){$q''$}
\tkzLabelSegment[auto](B,C){$q' $}
\tkzLabelSegment[auto](C,A){$ $}
...
\tkzDrawAltitude[dashed,color=magenta](C,B)(A)   %% draw the perpendicular
\tkzGetPoint{P}                                  %% get the point P
\tkzLabelPoint[below](P){$\phi^{4}$}                    %% label the point P
%\tkzDrawSegment[dashed,color=magenta](C,P)       %% draw CP
\tkzMarkRightAngle(C,A,B)

\tkzLabelSegment[auto,swap](B,A){$5$}
\tkzLabelSegment[auto](B,C){$w$}
\tkzLabelSegment[auto](C,A){$\sqrt{22}$}
...
\end{tikzpicture}
\caption{Sanchez Triangle properties.}
\end{figure}
...
\tkzMarkRightAngle(C,A,B)
\end{tikzpicture}
\caption{$\sqrt{(5.5)^2-(3.2)^2}$ Triangle properties.}
\end{figure}

\begin{figure}
\centering
\begin{tikzpicture}[x = 1 mm, y = 1 mm, scale = 2]
\label{tab:16:table16}
    ...
    \coordinate (D) at (\pgfmathresult:0 |- 18,0);
    \draw[red] (A) node[anchor=north east] {A}-- (B) node[anchor=north] {B} -- (C) node[anchor=south] {C} -- (D) node[anchor=south west] {D}--cycle;
\end{tikzpicture}
\caption{$asin(11/18)$ Triangle properties.}
\end{figure}
...
%\coordinate (A) at (2,1);
%\coordinate (B) at (-3,5);
\coordinate (A) at ($(O)!10.32cm!(B)$);
\coordinate (B) at ($(O)!5.52cm!(A)$);
...
\node [anchor = east] at (6.,2.5) {$\sqrt{a'}$};
\node [anchor = east] at (1.,-0.5) {$\sqrt{a''}$};
...
\draw[color=red] (6.,0.) -- (6.,5.52);
\draw[color=red] (-4.32,0.) -- (6.,5.52);
\draw[color=blue] (6.,0.) -- (3.,4.);
\node [anchor = east] at (3.,1.5) {$q$};
\node [anchor = east] at (6.,2.5) {$q''$};
\node [anchor = east] at (1.,-0.5) {$q'$};
\clip(-6.,-0.4) rectangle (0.4,3.4);
\draw [shift={(-4.3,0.)},color=gray,fill=darkgray,fill opacity=0.1] (0,0) -- (0.:0.6) arc (0.:26.9:0.6) -- cycle;
%\draw[color=gray,fill=darkgray,fill opacity=0.1] (0.,0.42) -- (-0.42,0.42) -- (-0.42,0.) -- (0.,0.) -- cycle; 
%\draw (0.,6.)-- (-4.32,0.);
...
\node [anchor = east] at (1.,1.5) {$h$};
\node [anchor = east] at (2.,2.5) {$5$};
\node [anchor = east] at (-1.,2.5) {$\sqrt{22}$};
\node [anchor = east] at (0.,-0.5) {$\phi^{4}$};
\node [anchor = east] at (2.,-0.5) {$\omega$};
\node [anchor = east] at (-1.,-0.5) {$z$};
\clip(-6.,-0.4) rectangle (0.4,3.4);
\draw [shift={(-3.3,0.)},color=gray,fill=darkgray,fill opacity=0.1] (0,0) -- (0.:0.6) arc (0.:26.9:0.6) -- cycle;
%\draw[color=gray,fill=darkgray,fill opacity=0.1] (0.,0.42) -- (-0.42,0.42) -- (-0.42,0.) -- (0.,0.) -- cycle; 
%\draw (0.,6.)-- (-4.32,0.);
%\draw (6.,5.52)-- (-4.32,0.);
%\draw (6.,0.)-- (6.,5.52);
...
%\tkzMarkRightAngle[fill=blue!20](B,F,C)
\end{tikzpicture}
\caption{Golden Sanchez Triangle properties.}
\end{figure}

\begin{figure}
\centering
\begin{tikzpicture}[x=3cm,y=3cm]
\draw[-,thick] (0,0) -- (1,1.5) -- (3,0);
\node [anchor = east] at (0,0) {M};
\node [anchor = east] at (1,1.5) {L};
\node [anchor = west] at (3,0) {T};
\node [anchor = east] at (1,0.) {$\phi^{4}$};
\node [anchor = east] at (1,0.375) {h};
\node [anchor = south] at (0.5,0) {\textit{z}};
\node [anchor = south] at (2.,0) {\textit{w}};
\draw[-,very thick] (0,0) -- (3,0);
\draw[-,very thick] (1,0) -- (1,1.5);
%\draw[{Bar[width=7mm][sep]Triangle[angle=20:10pt]}-{Triangle[angle=20:10pt][sep]Bar[width=7mm]},thick] (0,-0.25) -- node [anchor=north]{z} (2,-0.25);
%\draw[{Bar[width=7mm][sep]Triangle[angle=20:10pt]}-{Triangle[angle=20:10pt][sep]Bar[width=7mm]},thick] (1,-0.25) -- node [anchor=north]{w} (2,-0.25);
%\tkzMarkRightAngle[fill=blue!20](M,L,T)
\end{tikzpicture}
\caption{MLT Triangle properties.}
\end{figure}

    \begin{tikzpicture}[
my angle/.style = {draw,very thin,
                   angle radius=5mm,

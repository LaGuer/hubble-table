...
The Comos radius $R_C$ is defined by the holographic relation strting from the entropy of the Nambu radius $R_N$ defined from the Nambu mass m_N = am_e$, which is central in particle physics:

\begin{equation}
\pi (R_N/l_P)^2 = 2\pi R_C/l_P ~~~~~~~~   R_N = 2\bar^2/Gm_N^3
\end{equation}

The analysis shows that this Cosmos radius verifie, to 41 and 38 ppm:
...
\begin{equation}
T_C = \hbar^3/G^2m^5 = \habar^4/\rho_c^{3/2}G_F^{5/2} ~~~~~~~~   m/m_e = (p(ad_e/137)^2)^{2/3}
\end{equation}

This confirms the central role of the critical density $\rho_c = 3/8\piGt^2$, where $t = R/c$ is the Hubble time. 
...
\label{tab:6:table6}
  ...
  7 & $2N_{Ed}(l_P^2/\lambdabar_n) (r_H/\lambdabar_e)^3/ \pi 496^2 $ & 13.81207 & confirms the superstring 496\\

...
\tkzDefPoint[label={[align=left]right:$q$},xshift=00mm](4.0,-0.5){D}
...
\tkzDrawPoints(A,B,C,q)
\tkzDefMidPoint(B,q) \tkzGetPoint{D}
\tkzDefPoint[label={[align=left]right:$\sqrt{\omega z}$},xshift=-05mm](3.0,-0.5){D}
\tkzDefPoint[label={[align=right]right:$4 \cdot \sqrt{(3H\beta/n)}$},xshift=05mm](3.0,-1.5){D}
\tkzMarkRightAngle(A,B,C)
\tkzMarkRightAngle(B,q,C)
\tkzLabelPoints[below](A,B,C)

...
\tkzLabelSegment[sloped,above,text=blue](A,q){$z$}
\tkzLabelSegment[sloped,above,text=blue](C,q){$\omega$}
\tkzLabelSegment[sloped,text=blue,yshift=07.5mm](A,C){$\phi^4$}
\tkzMarkRightAngle(A,B,C)
\tkzMarkRightAngle(B,q,C)
\tkzLabelPoints[below](A,B,C)
...
%\tkzLabelAngle[pos=0.6](A,q,B){$\sqrt{\omega z}$}
  ...
  \draw [very thin,black,line join=round] (0,0,0)  -- node [sloped,above,xshift=-4.mm,yshift=-2.mm] {$4\sqrt{(3H\beta/n)}$} (4.9,1.,4.6);

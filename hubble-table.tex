...
\label{tab:1:table1}
  \hskip-2.5cm\begin{tabular}{llll}
   ...
   de Vries Electric constant  & $a_{deV} $   & 137.03599909582970048 & 'exact' \\
    ...
    Modular number & $j_0$    & 744  & exact \\ 
     ...
     Happy Family order product $\approx e^{674.5210288} $   & $\Pi_{hap}$   &$2^{301}\cdot 3^{142} \cdot 5^{57} \cdot 7^{30} \cdot 11^{18} \cdot 13^{10} \cdot 17^5 \cdot 19^4 \cdot 23^9 \cdot 31^3 \cdot 47\cdot D $  & exact \\
 ...
 First generation (Mathieu) product $\approx e^{68.8957364082420507}$ & $\Pi_{par}$   & $ M_{11} M_{12} M_{21} M_{22} M_{23}$    & exact \\
 
 Second generation product $\approx e^{179.541794334944999}$ & $\Pi_{par}$   & $J_2 ~~HS~~McL~~Suz~~CO_3~~CO_2 ~~CO_1     $    & exact \\
 
 Third generation product $\approx e^{ 426.083498006426259 }$ & $\Pi_{par}$   & F_1 F_2  F_{i24}F_{i23}F_{i22}F_3F_5F_7    & exact \\  

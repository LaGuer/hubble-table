...
\begin{equation}
O_M \approx (F/aa_s)^{20} \approx (a-136) ~ 95^{20}
\end{equation}
...
\section{The connections involving the main sporadic groups}
...
\begin{equation}
PFaf \approx O_B/\Pi_0 \aprox 48^{20}/\Pi_0
\end{equation}

where $O_B$ is the Baby-Monster group order.

Thus the $16 + 4 = 20$ main parameters are identified, tied to the product $O_M ~ O_B$ , which is closely tied to the photon number in the critical sphere \cite{Sanchez}. Thus, taking account of $f(11) \approx \pi \Pi_0$ to 20 ppm:

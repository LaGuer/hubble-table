...
%\begin{equation}
%\Pi_{12} = n \cdot p_+ \cdot p_-  \cdot   \Pi_0 \cdot  \Pi_+  \cdot  \Pi_- \cdot  K_0 \cdot K+- \cdot K_- \cdot Z \cdot  W_+  \cdot  W_-  %\approx P/aa_s
%\end{equation}


\begin{equation}
\Pi_{12} = n p_+ p_-  \Pi_0   \Pi_+    \Pi_-  K_0  K_+  K_- Z   W_+  W_-  \approx P/aa_s
\end{equation}
...
The above combination is close to the canonical term $f(24)$, corresponding to the 24 transverse dimensions. The analysis shoxs that:
...
So the Topological Axis shows a predictibility establishing without any doubt its pertinence. In particular the 24 transverses dimensions are connected to the 11 supergrave ones by the canonic relation $24 = 2 + 2\times 11$.


The canonical number 495 doubly connects with this series in the search for solutions involving 3 terms, among the 11, with powers limited to 2 and precision $5 \times 10^{-4} \approx (a/137)^2$:
...
A research on computer looking for an holographic relation, of type $3X^2 = Y^3$, between the terms $a, p_W, p and H$ leads to the 61 ppm relation, involving the canonic dimensions 16 and 24, and connecting with the monster group order to 100 ppm, which in turn connects with a combinaison of basic elements, to 1.5 ppm:

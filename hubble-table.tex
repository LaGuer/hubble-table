...
implying $\mu$ the mass ratio Muon-Electron. 
...
The weak mixing angle appears unambigously in:

\begin{equation}
a_0 = i^{\pi/i} \approx \pi^{1/ln\Phi ^2}
\end{equation}
...
\textit{This confirms the importance of the Golden number, and its associated weak mixing angle.}

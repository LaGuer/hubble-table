...
Feynman declared: The most beautiful one is the coupling constant, 137 point and so on, and all good theoretical physicists put that up on their wall and worry about it. There is at the present time no idea of any utility for getting at that number.
...
\begin{table}
\caption{55 formulas for Hubble radius, with better precision than $1.5 \times 10^{-4}$}
\label{tab:5:table5}
  \hskip-2.0cm\begin{tabular}{llll}
    \toprule
    %\multicolumn{4}{c}{}                   \\

...
\bibitem{devries} Hans de Vries. http://www.chip-architect.com/news/2004_10_04_The_Electro_Magnetic_coupling_constant.html , An exact formula for the Electro Magnetic coupling constant, web page, 2004 Oct 4. 
...
\label{tab:1:table1}
  \hskip-2.5cm\begin{tabular}{llll}
   ...
   de Vries Electric constant  & a    & 137.03599909582970048 & 'exact' \\
    ...
    Modular number & $j_0$    & 744  & exact \\ 
     ...
     Monster group order $\approx exp(124.1264234)$  & $O_M$    & $2^{46}\cdot 3^{20} \cdot 5^9 \cdot 7^6 \cdot 11^2 \cdot 13^3 \cdot 17\cdot 19 \cdot 23 \cdot29 \cdot 31 \cdot 41 \cdot 47 \cdot 59 \cdot 71$  & exact \\   
     
     Monster dimension & D    & $47 \cdot 59 \cdot 71 = 196883$   & exact \\
     
     Baby-Monster group order $\approx exp(77.4095679)$  & $O_B$    & $2^{41}\cdot 3^{13} \cdot 5^6 \cdot 7^2 \cdot 11 \cdot 13 \cdot 17\cdot 19 \cdot 23 \cdot 31 \cdot 47$  & exact \\
     
     Happy Family order product & $\Pi_{hap}$   & exp(674.5210288)  & exact \\
     
      Pariah Family product \approx exp(166.7658991) & $\Pi_{par}$   & $2^{62}\cdot 3^{23} \cdot 5^{13} \cdot 7^7 \cdot 11^6 \cdot 13 \cdot 17\cdot 19^3 \cdot 23 \cdot29^2 \cdot 31^3 \cdot 37^2 \cdot 43 \cdot 67 $   & exact \\

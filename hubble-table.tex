...
implying a role of the economic number $e^{e^e}$, while the deviation term is very close to $(2p_G/a^{2/3})^{1/137}$, $p_K/p_G$ and $p_{hol}/p_K$, where $p_G = P/2^{127/2}$ is the gravity-dependant approximation for $p$, $ p_{hol} = (4a^3/3)^{1/2} $ its holographic form and $p_K$ the Koyde factor introduced further.

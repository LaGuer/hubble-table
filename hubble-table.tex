...
\label{tab:6:table6}
  ...
  38 & $ (4/3)\lambdabar_e \phi^{\sqrt {n\sqrt{pH}/\beta}} $ & 13.81200 & confirms the golden ratio as calculation basis \\ 
   ...
   52 & $g(6)^{1/(1-1/\pi e)}/N_L^{1/(\pi e-1)}$ & 13.81198 & confirms the topogical term g(6) \\
    ...
    53 & $2 N_L \lambdabar_{e} (3p_K/2)^2 \times 137/Fsqrt{pH\beta}  $ & 13.81198 & confirms the Koide factor \\
    
    53 & $2 N_L \lambdabar_{e} (1-a^{7/2}/137^{3/2}pH  $ & 13.81198 & both $a$ and 137 are computional basis \\

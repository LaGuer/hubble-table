...
\section{The connection with the Periodic Table of Elements}
 ...
 \section{connection with the high-dimensional crystallography}
    ...
    Note that the roots of the crystallographic algebraic equation of degree $n$ are of type $exp(i2\pi m/l)$, where $l$ and $m$ are whole numbers such that $l \lesseq n$ and $1 \lesseq m \lesseq l$,  : this is similar to the above spectroscopic series. Such an unexpected connection needs also further study.   

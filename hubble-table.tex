...
\begin{table*}
  \hskip-2.0cm\begin{tabular}{llll}
    \toprule
    \multicolumn{4}{c}{Table 4. 41 formulas for the Hubble radius, with better precision than 1 \%}                   \\
    \cmidrule(r){1-4}
...
\begin{table*}
  \hskip-2.0cm\begin{tabular}{llll}
   ...
   15 & $ \lambdabar_{e} \sqrt{a/137} j_0^{2ep\beta/j_0}$ & 13.81139 & confirms the modular number as calculatiob basis\\ 
   16 & $\lambdabar_{e} j_0^{n/a}$ & 13.81189 & confirms the modular number as calculatiob basis\\\ 

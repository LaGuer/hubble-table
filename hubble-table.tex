...
\begin{equation}
Pi_{11} = a \cdot p \cdot  n \cdot  \mu \cdot  \tau \cdot  \Pi_0 \cdot  \Pi_+ \cdot  \K_0  \cdot K_+ Z \cdot  W
\end{equation}
...
\begin{equation}
495 \approx a (p/\K_+)^2 \approx n (a/\Pi_0)^2
\end{equation}

This shows how the charged Kaon, belonging to the so-called 'strange particles' appears to be important.

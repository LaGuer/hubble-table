...
%-------------------------------------- Two column figure (place early!)
   ...
   \end{itemize}
   For the Holic model Sanchez obtains necessary conditions
   for dynamical, secular and vibrational (or pulsational)
   stability. Using Sanchez's
   notation:
   \[
      \begin{array}{lp{0.8\linewidth}}
         m_{e}           & mass of the electron $r$   \\
         G               & Gravitational constant    \\
         H_0             & Hubble radius             \\
         p               & proton electron mass ratio  \\
         \lambdabar_e    & Electron Compton Wavelength \\
         h               & Planck Constant              \\
         T_{\mathrm{k}}  & Kotov Period
      \end{array}
   \]
\noindent
   and with the definitions of the \emph{3rd Diophantian Kepler law\/}
   %% (see Fig.~\ref{FigGam})
   \begin{equation}
